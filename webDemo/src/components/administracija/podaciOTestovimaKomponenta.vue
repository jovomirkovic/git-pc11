      ...
      :loading="loadingUtakmice"
        ...
        >
          <template v-slot:top-right="props">
            <q-btn @click="otvordeDialog()" :label="$t('administration.testData.newTest')" class="q-mr-xs dugmeNewNesto" />
          ...
          <template v-slot:body-cell="props">
            ...
            <q-td :props="props" v-else-if="props.value == props.row.datumVreme" @click="otvoriPreviewDialog(props.row)">
                ...
                <q-list>
                    ...
                    >
                      <template v-slot:append>
                        ...
                        <q-popup-proxy ref="qDateProxy1" transition-show="scale" transition-hide="scale">
                          <q-date
                      :readonly="readonly" mask="DD/MM/YYYY" v-model="editedItem.datumVreme" @input="() => $refs.qDateProxy1.hide()"></q-date>
                        </q-popup-proxy>
                        </q-icon>
                      </template>
                      </q-input>
                      <span id="Span-IP0" class="placeholder">{{$t('administration.professionalStaff.contractExpiration')}}</span>
                    </label>
                  </q-item>
                  <q-item style="width: 45%; display: inline-block;">
                    <q-item-section class="custom-field one">
                      ...
                      :readonly="readonly"
                        ...
                        @blur="spustiPlaceholder('Span-SL1', editedItem.kategorijaTesta)"
                        :rules="[
                          (val) =>
                            (val !== null && val !== '') ||
                      ...
                      />
                      <span @click="$refs.select1.showPopup()" id="Span-SL1" class="placeholder placeholder1">{{$t('administration.testData.categTest')}}</span>
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section class="custom-field one">
                      ...
                      :readonly="readonly"
                        ...
                        @blur="spustiPlaceholder('Span-SL2', editedItem.vrednostKojaSeUtvrdjuje)"
                        :rules="[
                          (val) =>
                            (val !== null && val !== '') ||
                      ...
                      />
                      <span @click="$refs.select2.showPopup()" id="Span-SL2" class="placeholder placeholder1">{{$t('administration.testData.testValue')}}</span>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      <q-editor
                      :readonly="readonly" v-model="editedItem.opis" :label="$t('administration.testData.desc')" min-height="5rem" />
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section>
                      ...
                      <q-editor
                      :readonly="readonly" v-model="editedItem.protokol" :label="$t('administration.testData.protocol')" min-height="5rem" />
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section>
                      ...
                      :readonly="readonly"
                          ...
                          @blur="spustiPlaceholder('Span-IP1', editedItem.instrument)"
                         />
                        <span id="Span-IP1" class="placeholder">{{$t('administration.testData.instrument')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section>
                      ...
                      :readonly="readonly"
                         ...
                         />
                        <span id="Span-IP2" class="placeholder">{{$t('administration.testData.operator')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      :readonly="readonly"
                          ...
                          @blur="spustiPlaceholder('Span-IP3', editedItem.institucija)"
                         />
                        <span id="Span-IP3" class="placeholder">{{$t('administration.testData.institution')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
            ...
            <q-card-section class="q-pt-none">
              <q-form class="q-gutter-md">
                <q-list>
                  ...
                  <q-item>
                    <q-item-section>
                      <q-card-section style="border: 0.5px solid #323b62; border-radius: 5px;" v-html="editedItem.opis" />
                    </q-item-section>
                    <label style="background-color: #ffffff; color: #323b62; margin-left: 12px !important; position: absolute; top: 0px; padding: 0px 5px">
                      {{$t('administration.testData.desc')}}
                    </label>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <q-card-section style="border: 0.5px solid #323b62; border-radius: 5px;" v-html="editedItem.protokol" />
                    </q-item-section>
                      <label style="background-color: #ffffff; color: #323b62; margin-left: 12px !important; position: absolute; top: 0px; padding: 0px 5px">
                        {{$t('administration.testData.protocol')}}
                      </label>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                         ...
                         />
                        <span class="placeholder">{{$t('administration.testData.instrument')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                         ...
                         />
                        <span class="placeholder">{{$t('administration.testData.operator')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                         ...
                         />
                        <span class="placeholder">{{$t('administration.testData.institution')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
...
export default {
  ...
  methods: {
    ...
    otvoriPreviewDialog(item){
      ...
      this.editedItem.datumVreme = date.formatDate(this.editedItem.datumRodjenja, 'DD/MM/YYYY')
    ...
    //........................................
    getDataZaID() {
    let linkStr = this.$apiPutanja + '/podaci-o-testiranju-igraca/igrac/' + window.$userID
...
debugger
    ...
    putData() {
    debugger
      let linkStr = this.$apiPutanja +  '/podaci-o-testiranju-igraca/' + this.editedItem.ident
      var self=this;
      var datumVreme1
      try {
        datumVreme1 = this.getDateTime(this.editedItem.datumVreme);
...
debugger
    ...
    //........................................
    deleteData(item) {
      let linkStr = this.$apiPutanja +  '/podaci-o-testiranju-igraca/' + item.ident
      var self=this;
      this.$axios
        .delete(linkStr, {
          headers: {
    ...
    addRow() {
      ...
      if (this.editedItem.kategorijaTesta == null || this.editedItem.kategorijaTesta == "")
        sveOK = false;
      if (this.editedItem.vrednostKojaSeUtvrdjuje == null || this.editedItem.vrednostKojaSeUtvrdjuje == "")
        sveOK = false;
