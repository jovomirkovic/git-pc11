      ...
      :loading="loadingUtakmice"
        ...
        >
          ...
          <template v-slot:top-right="props">
            <q-btn v-if="selectedGrupa.length > 0" @click="otvordeDialog()" :label="$t('administration.technique.items.newItem')" class="q-mr-xs dugmeNewNesto" />
            ...
            <q-card-section class="q-pt-none">
              <q-form class="q-gutter-md">
                <q-list>
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      :readonly="readonly"
                        ...
                        <span id="Span-IP1" class="placeholder">{{$t('administration.technique.items.name')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label>{{$t('administration.technique.items.desc')}}</label>
                      <q-editor
                      :readonly="readonly" v-model="editedItem.opis" :label="$t('administration.technique.items.desc')" min-height="5rem" />
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      :readonly="readonly"
                        ...
                        />
                        <span class="placeholder">{{$t('administration.technique.items.video')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                          ...
                          />
                        <span class="placeholder">{{$t('administration.technique.items.name')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
...
export default {
  ...
  methods: {
    ...
    //........................................
    getDataStavke() {
      let linkStr = this.$apiPutanja +  '/baza-tehnike-sifrarnik-stavke?identGrupe=' + this.selectedGrupa[0].ident
      debugger;
        this.$axios
          .get(linkStr,{
                headers: {
...
debugger
    ...
    putData() {
    debugger
      let linkStr = this.$apiPutanja +  '/baza-tehnike-sifrarnik-stavke/' + this.editedItem.ident
      var self=this;
...
debugger
    ...
    deleteData(item) {
    debugger
      let linkStr = this.$apiPutanja +  '/baza-tehnike-sifrarnik-stavke/' + item.ident
      var self=this;
debugger
      this.$axios
        .delete(linkStr, {
