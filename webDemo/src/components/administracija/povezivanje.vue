        ...
        <div class="scroll" style="height: 100%">
          ...
          <template v-slot:header>
            <span style="width: 100%;">
              <span style="display: inline-block; margin: 9px 0px">{{$t('administration.connections.professionalStaff')}}</span>
          ...
          <q-expansion-item
            ...
            header-style= " background: #ff4b00; color: white;" @click="tabelaDvaZatvorena = !tabelaDvaZatvorena; jednaUkljucenaFn()"            expand-icon-class="text-white"
          >
            <!-- tabela igraca      -->
            <template v-slot:header>
            <span style="width: 100%;">
                      ...
                      >
                        <q-list dense style="min-width: 100px">
                          <q-item clickable v-close-popup>
                            <q-item-section @click="skloniStrucniTim(d, true)">{{$t('administration.connections.delete')}}</q-item-section>
                          </q-item>
                        </q-list>
                      </q-menu>
                      <q-card-section class="col">
                        <div class="text-h col-2" style="height: 50px">{{d.rolesOpisno[1]}} : {{d.ime + " " + d.prezime}}</div>
                      </q-card-section>
                    </q-card>
              </div>
              <span
                  ...
                  style="
                    ...
                    overflow: hidden;
                  "
                  :style="{border: [lastAddedPlayerID == igrac.id ? '5px solid #c9f2df' : 'unset']}"
                v-close-popup
                >
                <q-menu
                  touch-position
                ...
                >
                  <q-list dense style="min-width: 100px">
                    <q-item clickable v-close-popup>
                      <q-item-section @click="pozicije(igrac, true)">{{$t('administration.connections.changeData')}}</q-item-section>
                    </q-item>
                    <q-item clickable v-close-popup>
                      <q-item-section @click="brisanje(igrac, true)">{{$t('administration.connections.delete')}}</q-item-section>
                    </q-item>
                  </q-list>
                </q-menu>
                  <img :src="igrac.fotografija"  style="width: 110px; height: 146px; object-fit: cover;" />
                  <p class='backgroundChange' style="margin: 0px; font-size: 10pt;  margin-top: -6px; padding: 3px; background-color:#7c92cc; color: white;">{{igrac.ime }} <br> {{  igrac.prezime}} </p>
                  <p class='backgroundChange flex flex-center' :style="{backgroundColor: [vratiBojuPozicije(igrac.primarnaPozicija.code)]}" style="height: 75px; font-size: 10pt; margin: 0px; padding: 10px; background-color:#323b62; color: white;"><span>{{igrac.primarnaPozicija != undefined ? igrac.primarnaPozicija.name : ''}}</span></p>
                </span>
                  ...
                  <q-item class="formular1 ponisti" style="width: 35%; margin-top: 10px;">
                    <label class="custom-field one datumInput">
                      <q-input
                        ...
                        @blur="spustiPlaceholder('Span-IP1', editedItem.datumPrelaska)"
                        ref="input1"
                        mask="##/##/####"
              ...
              <q-item>
                <q-item-section class="custom-field one">
                  <q-select
                    ...
                    v-on:input="promenaPrimarnePozicije(editedItem.id, editedItem.primarnaPozicija)"
                    :rules="[
                      (val) =>
                  ...
                  />
                  <span @click="$refs.select1.showPopup()" id="Span-SL1" class="placeholder placeholder1">{{$t('administration.connections.positionPrim1')}}</span>
                </q-item-section>
              </q-item>
              ...
              <q-item>
                <q-item-section class="custom-field one">
                  <q-select
                    ...
                    v-on:input="promenaSekundarnePozicije(editedItem.id, editedItem.sekundarnaPozicija)"
                    :rules="[
                      (val) =>
                        (val !== null && val !== '' && val != undefined) ||
                        $t('administration.connections.enterPos'),
                  ...
                  />
                  <span @click="$refs.select2.showPopup()" id="Span-SL2" class="placeholder placeholder1">{{$t('administration.connections.positionSec1')}}</span>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section class="custom-field one">
                  <q-select
                    ...
                    v-on:input="promenaTercijarnePozicije(editedItem.id, editedItem.tercijarnaPozicija)"
                    :rules="[
                      (val) =>
                        (val !== null && val !== '' && val != undefined) ||
                        $t('administration.connections.enterPos'),
                  ...
                  />
                  <span @click="$refs.select3.showPopup()" id="Span-SL3" class="placeholder placeholder1">{{$t('administration.connections.positionTerc1')}}</span>
                </q-item-section>
              </q-item>
            </q-list>
          </q-form>
            ...
            <q-list>
              ...
              <!-- <q-item v-if="izborBrisanja=='brisiRegularno'" class="formular ponisti" style="">
                <q-input dense outlined v-model="editedItem.datumPrestanka" :label="$t('administration.connections.dateTermination')" mask="date" :rules="['date']" class="datumKlasa">
                  ...
                  <q-item v-if="izborBrisanja=='brisiRegularno'" class="formular1 ponisti" style="width: 35%; margin-top: 10px;">
                    <label class="custom-field one datumInput">
                      <q-input
                        borderless
                        dense
                        ...
                        @blur="spustiPlaceholder('Span-IP3', editedItem.datumPrestanka)"
                        ref="input3"
                        mask="##/##/####"
                        :rules="[val => valiDate(val) || 'DD/MM/YYYY']"
                       >
