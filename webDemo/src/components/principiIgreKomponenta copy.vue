  ...
  <q-page class="q-pa-sm">
        ...
        >
          <template v-slot:top-right="props">
            <q-btn @click="otvordeDialog()" outline color="primary" label="Novi princip" class="q-mr-xs" />
...
<!--                   <q-item class="formular ponisti" style="">
                  ...
                  <q-item>
                    <q-item-section>
                      <q-input dense outlined v-model="editedItem.naziv" label="Naziv"></q-input>
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section>
                  ...
                  <div class="row">
                    <q-item style="width:90%">                    
                      <q-item-section>
                        <q-input dense outlined v-model="editedItem.elementTaktike.naziv" label="Element taktike"></q-input>
                      </q-item-section>
                    </q-item>   
                    <q-btn
                      flat
                  ...
                  <div class="row">
                    <q-item style="width:90%">                    
                      <q-item-section>
                        <q-input dense outlined v-model="editedItem.identPrimarnogElementaTehnike" label="Primarni element tehnike"></q-input>
                      </q-item-section>
                    </q-item>  
                    <q-btn
                        flat
                  ...
                  <div class="row">
                    <q-item style="width:90%">                    
                      <q-item-section>
                        <q-input dense outlined v-model="editedItem.identSekundarnogElementaTehnike" label="Sekundarni element tehnike"></q-input>
                      </q-item-section>
                    </q-item>    
                    <q-btn
                        flat
        ...
        <q-dialog persistent v-model="izborPrimarneTehnike">
          <q-card style="width: 600px; max-width: 60vw;">
            ...
            <q-card-actions align="right" class="bg-white text-teal">
              <q-btn label="Odustani" @click="zatvoriDialogPrimarneTehnike" type="submit" color="primary" v-close-popup />
              <q-btn label="Snimi" @click="izabranaPrimarneTehnikeFN" type="submit" color="primary" v-close-popup />
            </q-card-actions>
          </q-card>
        </q-dialog>
        ...
        <q-dialog persistent v-model="izborSekundarneTehnike">
          <q-card style="width: 600px; max-width: 60vw;">
            ...
            <q-card-actions align="right" class="bg-white text-teal">
              <q-btn label="Odustani" @click="zatvoriDialogSekundarneTehnike" type="submit" color="primary" v-close-popup />
              <q-btn label="Snimi" @click="izbranaSekundarneTehnikeFN" type="submit" color="primary" v-close-popup />
            </q-card-actions>
          </q-card>
        </q-dialog>
        ...
        <q-dialog persistent v-model="izborTaktike">
          <q-card style="width: 600px; max-width: 60vw;">
            ...
            <q-card-actions align="right" class="bg-white text-teal">
              <q-btn label="Odustani" @click="zatvoriDialogTaktike" type="submit" color="primary" v-close-popup />
              <q-btn label="Snimi" @click="izbranaTaktikaFN" type="submit" color="primary" v-close-popup />
            </q-card-actions>
          </q-card>
        </q-dialog>
...
export default {
  ...
  methods: {
    ...
    izbranaTaktikaFN() {
      ...
      this.editedItem.ElementTaktike.naziv = this.grupaElementaTaktike + ' ' + this.elementTaktike
    },
    ...
    //........................................
    getDataStavke() {       
      let linkStr = this.$apiPutanja +  '/baza-tehnike-sifrarnik-stavke?identGrupe=' + this.selektovanaGrupaTehnike
      debugger;
        this.$axios
          .get(linkStr,{
                headers: {
    ...
    getDataStavkeTaktike() {       
      let linkStr = this.$apiPutanja +  '/baza-taktike-sifrarnik-stavke?identGrupe=' + this.selektovanaGrupaTaktike
      debugger;
        this.$axios
          .get(linkStr,{
                headers: {
