<template>
  <q-page class="q-pa-sm">
      ...
      :loading="loadingUtakmice"
          ...
          color="blue-10"
        >
          <template v-if="igr != $t('players.motorSkills.FMS.selectPlayer') + ' ->'" v-slot:top-right="props">
            <q-btn
          v-if="Object.keys(selektovaniIgrac).length != 0" @click="otvordeDialog()" :label="$t('players.motorSkills.FMS.newMesurement')" class="q-mr-xs dugmeNewNesto" />
            ...
            >
              <q-tooltip
                :disable="$q.platform.is.mobile"
                v-close-popup
              >{{mode==='grid' ? $t('players.motorSkills.FMS.list') : $t('players.motorSkills.FMS.grid')}}</q-tooltip>
            </q-btn>
            ...
            <q-td :props="props" v-if="props.value == props.row.action">
              <div class="q-gutter-sm">
                ...
                <q-btn
                  ...
                  icon="edit"
                >
                  <q-tooltip>{{ $t("players.motorSkills.FMS.changeData") }}</q-tooltip>
                </q-btn>
              </div>
            </q-td>
                ...
                <q-list>
                  <q-item class="formular" style="">
                    <label class="custom-field one datumInput">
                      ...
                      <span id="Span-IP0" class="placeholder">{{$t('players.motorSkills.FMS.date')}}</span>
                    </label>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <q-input
                          ...
                          @blur="spustiPlaceholder('Span-IP1', editedItem.korisnikImePrezime)"
                        />
                        <span id="Span-IP1" class="placeholder">{{$t('players.motorSkills.FMS.whoDidTheTesting')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                      ...
                      <label class="custom-field one" style="height: 75px;">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.foldingLegsLeft')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.pregibanjeNogeLevo = item.value; fn4pregibanjeNogeUkupno()"
                          style="
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.pregibanjeNogeLevo == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                      ...
                      <label class="custom-field one">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.foldingLegsRight')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.pregibanjeNogeDesno = item.value; fn4pregibanjeNogeUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.pregibanjeNogeDesno == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        <input style="cursor:not-allowed" readonly placeholder=" " @keyup="fn4Ukupno" dense outlined v-model="editedItem.pregibanjeNogeUkupno" :label="$t('players.motorSkills.FMS.foldingLegsBoth')"/>
                        <span style="cursor:not-allowed" class="placeholder">{{$t('players.motorSkills.FMS.foldingLegsBoth')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                      ...
                      <label class="custom-field one" style="height: 75px;">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.squatWithCausation')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.cucanj = item.value; fn4Ukupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.cucanj == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                      ...
                      <label class="custom-field one" style="height: 75px;">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.inLineStepLeft')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.liniskiIskorakLevo = item.value; fn4liniskiIskorakUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.liniskiIskorakLevo == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                      ...
                      <label class="custom-field one">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.inLineStepRight')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.liniskiIskorakDesno = item.value; fn4liniskiIskorakUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.liniskiIskorakDesno == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        <input style="cursor:not-allowed" placeholder=" " @keyup="fn4Ukupno" dense outlined v-model="editedItem.liniskiIskorakUkupno" :label="$t('players.motorSkills.FMS.inLineStepTotal')"/>
                        <span style="cursor:not-allowed" class="placeholder">{{$t('players.motorSkills.FMS.inLineStepTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                      ...
                      <label class="custom-field one" style="height: 75px;">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.pushup')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.sklek = item.value; fn4Ukupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.sklek == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                      ...
                      <label class="custom-field one" style="height: 75px;">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.groinCrossingLeft')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.prelazakPreponaLevo = item.value; fn4prelazakPreponaUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.prelazakPreponaLevo == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                      ...
                      <label class="custom-field one">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.groinCrossingRight')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.prelazakPreponaDesno = item.value; fn4prelazakPreponaUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.prelazakPreponaDesno == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        <input style="cursor:not-allowed" placeholder=" " @keyup="fn4Ukupno" dense outlined v-model="editedItem.prelazakPreponaUkupno" :label="$t('players.motorSkills.FMS.groinCrossingTotal')"/>
                        <span style="cursor:not-allowed" class="placeholder">{{$t('players.motorSkills.FMS.groinCrossingTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                      ...
                      <label class="custom-field one" style="height: 75px;">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.rotationalStabilityLeft')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.rotacionaStabilnostLevo = item.value; fn4rotacionaStabilnostUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.rotacionaStabilnostLevo == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                      ...
                      <label class="custom-field one">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.rotationalStabilityRight')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.rotacionaStabilnostDesno = item.value; fn4rotacionaStabilnostUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.rotacionaStabilnostDesno == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        <input style="cursor:not-allowed" placeholder=" " @keyup="fn4Ukupno" dense outlined v-model="editedItem.rotacionaStabilnostUkupno" :label="$t('players.motorSkills.FMS.rotationalStabilityTotal')"/>
                        <span style="cursor:not-allowed" class="placeholder">{{$t('players.motorSkills.FMS.rotationalStabilityTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                      ...
                      <label class="custom-field one" style="height: 75px;">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.shoulderMobilityLeft')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.pokretljivostRamenaLevo = item.value; fn4pokretljivostRamenaUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.pokretljivostRamenaLevo == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                      ...
                      <label class="custom-field one">
                        <p
                          style="
                            ...
                            margin-bottom: 0px;
                          "
                        >{{$t('players.motorSkills.FMS.shoulderMobilityRight')}}</p>
                        <div
                      :readonly="readonly"
                          class="q-gutter-sm"
                          v-for="(item, index) in thomasTest4Options"
                          :key="item + ' ' + index"
                          @click="editedItem.pokretljivostRamenaDesno = item.value; fn4pokretljivostRamenaUkupno()"
                          style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                            ...
                            cursor:pointer;
                          "
                          :style="{border: [editedItem.pokretljivostRamenaDesno == item.value ? '2px solid #3b5d99' : '2px solid white']}"
                        >
                          {{ item.label }}
                        </div>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        <input style="cursor:not-allowed" placeholder=" " @keyup="fn4Ukupno" dense outlined v-model="editedItem.pokretljivostRamenaUkupno" :label="$t('players.motorSkills.FMS.shoulderMobilityTotal')"/>
                        <span style="cursor:not-allowed" class="placeholder">{{$t('players.motorSkills.FMS.shoulderMobilityTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        <input style="cursor:not-allowed" placeholder=" " dense outlined v-model="editedItem.ukupnaOcena" :label="$t('players.motorSkills.FMS.overallFMSTestScore')"/>
                        <span style="cursor:not-allowed" class="placeholder">{{$t('players.motorSkills.FMS.overallFMSTestScore')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item v-if="this.editedIndex > -1">
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.whoDidTheTesting')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.foldingLegsBoth')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.inLineStepTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.groinCrossingTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                          ...
                          :label="$t('players.motorSkills.FMS.rotationalStabilityLeft')"
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.rotationalStabilityLeft')}}</span>
                      </label>
                    </q-item-section>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                          ...
                          :label="$t('players.motorSkills.FMS.rotationalStabilityRight')"
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.rotationalStabilityRight')}}</span>
                      </label>
                    </q-item-section>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                          ...
                          :label="$t('players.motorSkills.FMS.rotationalStabilityTotal')"
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.rotationalStabilityTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                          ...
                          :label="$t('players.motorSkills.FMS.shoulderMobilityLeft')"
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.shoulderMobilityLeft')}}</span>
                      </label>
                    </q-item-section>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                          ...
                          :label="$t('players.motorSkills.FMS.shoulderMobilityRight')"
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.shoulderMobilityRight')}}</span>
                      </label>
                    </q-item-section>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                          ...
                          :label="$t('players.motorSkills.FMS.shoulderMobilityTotal')"
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.shoulderMobilityTotal')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('players.motorSkills.FMS.overallFMSTestScore')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
...
export default {
  ...
  methods: {
    ...
    fn4pregibanjeNogeUkupno() {
      debugger
      if(this.editedItem.pregibanjeNogeDesno > this.editedItem.pregibanjeNogeLevo) {
    ...
    fn4liniskiIskorakUkupno() {
      debugger
      if(this.editedItem.liniskiIskorakDesno > this.editedItem.liniskiIskorakLevo) {
    ...
    fn4prelazakPreponaUkupno() {
      debugger
      if(this.editedItem.prelazakPreponaDesno > this.editedItem.prelazakPreponaLevo) {
    ...
    fn4pokretljivostRamenaUkupno() {
      debugger
      if(this.editedItem.pokretljivostRamenaDesno > this.editedItem.pokretljivostRamenaLevo) {
    ...
    fn4rotacionaStabilnostUkupno() {
      debugger
      if(this.editedItem.rotacionaStabilnostDesno > this.editedItem.rotacionaStabilnostLevo) {
    ...
    fn4Ukupno() {
      this.editedItem.ukupnaOcena=Number(this.editedItem.pregibanjeNogeUkupno)+Number(this.editedItem.liniskiIskorakUkupno)+Number(this.editedItem.prelazakPreponaUkupno)+Number(this.editedItem.pokretljivostRamenaUkupno)+Number(this.editedItem.rotacionaStabilnostUkupno)+Number(this.editedItem.cucanj)+Number(this.editedItem.sklek)
    },
    //''''''''''''''''''''''''''''''''''''''''
    // citanje igraca
    //........................................
...
debugger
      this.$axios
        ...
        .then(function(response) {
          ...
          self.getDataZaID();
          self.$q.notify({
            message: self.$t('players.motorSkills.FMS.newMeasurementSuccessfullyAdded'),
          color: "green"
        });
        })
...
debugger
      this.$axios
        ...
        .then(function(response) {
          ...
          self.getDataZaID();
          self.$q.notify({
            message: self.$t('players.motorSkills.FMS.measurementDataChangedSuccessfully'),
          color: "green"
        });
        })
        .catch(function(response) {
    ...
    deleteData(item) {
      ...
      this.$axios
        ...
        .then(function(response) {
          ...
          self.getDataZaID();
          self.$q.notify({
            message: self.$t('players.motorSkills.FMS.measurementDataDeletedSuccessfully'),
          color: "green"
        });
        })
        .catch(function(response) {
