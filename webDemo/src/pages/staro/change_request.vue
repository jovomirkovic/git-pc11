  ...
  <q-page class="q-pa-sm">
    ...
    >
      <template v-slot:top-right="props">
        <q-btn @click="otvordeDialog()" outline color="primary" label="Add New" class="q-mr-xs" />
      ...
      <q-card style="width: 600px; max-width: 60vw;">
        <q-card-section>
          <div class="text-h6">
            ...
            <q-btn @click="close" round flat dense icon="close" class="float-right" color="grey-8" v-close-popup></q-btn>
          </div>
        </q-card-section>
