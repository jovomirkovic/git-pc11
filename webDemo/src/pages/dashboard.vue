...
<iframe width="100%" height="700px" src="https://app.powerbi.com/view?r=eyJrIjoiMDg5ZjU3ODgtMjUxZi00OGExLTlmYjktM2NiZTRlNzkwOTcxIiwidCI6Ijg1NDBjZGYzLWVjZDgtNDI1Ny1iMDNlLWFjNjhkYjVmOGZiZiIsImMiOjh9" frameborder="0" allowFullScreen="true"></iframe>
                ...
                barChartOption: {
                    ...
                    dataset: {
                        ...
                        source: [
                            ...
                            {time_period: '2', svi: 5, ekipa: 6},
                            {time_period: '3', svi: 70, ekipa: 65},
                            {time_period: '4', svi: 12, ekipa: 10},
          ...
          menjajBorg: function () {
              ...
              setInterval(function () {
                if(self.borgOptions.series[0].data[0].value == 2.97) {
                  ...
                  self.borgOpis = "Najmanje opterećen igrač: Pade Tot";
                }
