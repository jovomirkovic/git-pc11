              ...
              <q-item>
                <q-item-section class="custom-field one">
                  <q-select
                    ...
                    @blur="
                      spustiPlaceholder('Span-SL4', editedItem.ocenaIzvodjenja)
                    "
                  />
                  <span
  ...
  methods: {
    ...
    dajLog(item) {
      ...
      return {
        ident: item.ident,
        vremeUnosa: new Date(
          new Date(item.vremeUnosa).getTime() + 2 * 60 * 60 * 1000
        ).toString(),
        type: item.type,
    ...
    putLogUtakmice() {
      ...
      var dataString = {
        ...
        vremeUnosa: this.getDateTime1(
          date.formatDate(this.editedItem.vremeUnosa, "YYYY-MM-DD") +
            "T" +
            this.samoVreme +
            ".000Z"
        )
