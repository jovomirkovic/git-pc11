<template>
  <q-page class="q-pa-sm">
    ...
    <q-dialog persistent v-model="new_customer">
      <q-card
        style="width: 800px; max-width: 80vw; border-radius: 5px; box-shadow: 0px 15px 25px 0px rgba(50, 50, 50, 0.7);"
      >
        <q-card-section>
          <div class="text-h6">
            {{ this.naslov }}
...
export default {
  ...
  methods: {
    ...
    dajLog(item) {
      ...
      if (_bazaTehnikeSifrarnikStavke != "")
        stavkaKojaSeOcenjujeID = _bazaTehnikeSifrarnikStavkeID;
      if (_bazaTaktikeSifrarnikStavke != "")
        stavkaKojaSeOcenjujeID = _bazaTaktikeSifrarnikStavkeID;
    ...
    //........................................
    promeniIgraca() {
      this.editedItem.vremeUnosa = this.getDateTime1(
        this.editedItem.vremeUnosa
      );
    ...
    putLogUtakmice() {
      ...
      var identBazaTaktikeSifrarnikStavke,
        identBazaTehnikeSifrarnikStavke,
        identPrincipIgre;

      switch (this.editedItem.type) {
        case "TEHNIKA":
          identBazaTehnikeSifrarnikStavke = this.editedItem
            .identBazaTehnikeSifrarnikStavkeID;
          identBazaTaktikeSifrarnikStavke = null;
          identPrincipIgre = null;
          break;
        case "TAKTIKA":
          identBazaTehnikeSifrarnikStavke = null;
          identBazaTaktikeSifrarnikStavke = this.editedItem
            .identBazaTaktikeSifrarnikStavkeID;
          identPrincipIgre = null;
          break;
        case "PRINCIP_IGRE":
          identBazaTehnikeSifrarnikStavke = null;
      ...
      let linkStr =
        this.$apiPutanja + "/element-sa-utakmice/" + this.editedItem.ident;
      ...
      var dataString = {
        ...
        vremeUnosa: this.getDateTime1(
          this.samoDatum + "T" + this.samoVreme + ".000Z"
        )
      };
    ...
    editItem(item) {
      ...
      this.samoDatum = date.formatDate(
        this.editedItem.vremeUnosa,
        "YYYY-MM-DD"
      );
