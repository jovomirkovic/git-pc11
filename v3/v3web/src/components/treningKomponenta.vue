<template>
  <q-page class="q-pa-sm">
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP2" class="placeholder"
                      >{{ $t("trainings.temperature") }} [°C]</span
                    >
                  </label>
                </q-item-section>
                <q-item-section
                ...
                <q-item-section>
                  <label class="custom-field one datumInput">
                    ...
                    <span
                      ...
                      style="left: 40px"
                      class="placeholder"
                      >{{ $t("trainings.trainingStart") }}</span
                    >
                    <!-- <label class="custom-field one">
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    <q-input
                      ...
                      dense
                      placeholder=" "
                      v-model="editedItem.vremeTrajanja"
                    ...
                    <span id="Span-IP4" class="placeholder"
                      >{{ $t("trainings.trainingDurationMin") }} [min]</span
                    >
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    <q-input
                      ...
                      dense
                      placeholder=" "
                      v-model="editedItem.opisniCiljTreningaUPripremi"
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    <q-input
                      ...
                      dense
                      placeholder=" "
                      v-model="editedItem.opisnaOcenaTreninga"
              ...
              <q-item>
                ...
                <q-item-section>
                  <q-select
                    ...
                    borderless
                    style="background: #f5f8fb; color: #323b62; height: 45px; border-radius: 5px; padding-left: 14px !important;"
                    :label="$t('trainings.trainingType')"
                    :options="listaTipovaTreninga"
                    v-model="editedItem.tipTreninga"
                    emit-value
                    map-options
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      ...
                      type="text"
                      placeholder=" "
                      v-model="editedItem.vremeTrajanjaTreninga"
    ...
    <q-dialog
      :full-width="maximizedToggle"
      :full-height="maximizedToggle"
      v-model="dialogZaTokTreninga"
      persistent
    ...
    >
      <q-card
        style="width: 100vw; max-width: 100vw; height:100%; overflow: hidden; "
        flat
        bordered
      >
        ...
        <q-spinner
          v-if="zabraniKlik"
          style="position: absolute; top: 45%; left: 45%;z-index: 1001;"
          color="primary"
          size="3em"
          :thickness="10"
        />
        ...
        <q-item style="height: 10%">
          ...
          <q-btn
            ...
            round
            dense
            style="float: right; width: fit-content; width: 40px; height: 40px;"
            v-close-popup
          ></q-btn>
        </q-item>
        ...
        <q-card-section horizontal style="height:90%">
          ...
          <q-card-section class="col-9" id="ovdeUbaciKlonove">
            ...
            <div class="vanTabele">
              ...
              <div class="uTabeli" style="text-align: center;">
                <q-btn
                  style=""
                  @click="skratiUtakmicu1()"
                  class="dugmeNewNesto1"
              ...
              <div class="uTabeli" style="text-align: -webkit-right;">
                <div
                  style="text-align: center; margin: auto; background-color: #e5edf4;
                ...
                >
                  <span
                    ...
                    style="font-size: 30px; color: #3b5d99; margin: auto;"
                  >
                    delete
                  </span>
                </div>
            ...
            <!-- Vremenske linije -->
            <div
              v-for="(items, index) in sviTimelinovi"
              :key="index"
            ...
            >
              ...
              <div class="row" id="timeline">
                <div
                  class="col"
                  v-for="i in kraceTrajanjeIzabranogTreninga"
                  :key="i + 10"
              ...
              <div
                class="row"
                style="border-left: 1px solid #000000ff;border-right: 1px solid #000000ff;"
                :id="'timelineBroj' + index"
              >
                <div
                  class="col"
                  v-for="i in kraceTrajanjeIzabranogTreninga"
                  :key="i + ' - sekcija od 5 minuta'"
            ...
            <q-card
              v-for="element in sviKlonovi"
              :key="(element.id + 1) * -1"
              bordered
              :id="'klonovi' + element.id"
              class="my-card trenazne-vezbe"
              :style="{ backgroundColor: allColors[element.id] }"
            ...
            >
              ...
              <q-menu :offset="[-50, 10]" context-menu>
                <q-list dense style="min-width: 100px;">
                  <q-item
                    @click="postavkeTrenazneVezbe(element)"
                    clickable
                    v-close-popup
                  >
              ...
              <q-card-section
                style="padding: 0px; width: 100%;height: 100%;margin: 0px;"
              >
                <div class="row" style="height: 100%;">
                  <!-- Promena trajanja trenazne vezbe - leva strana -->
                  <div
                    class="col-1 strelice"
                    style="text-align: left;margin: auto;width:10px;"
                  ...
                  <div
                    class="col-1 strelice"
                    style="text-align: right;margin: auto;width: 10px;"
              ...
              <q-card>
                ...
                <q-card-section class="q-pa-none">
                  ...
                  <quill-editor
                    disabled
                    class="editor"
                    :value="pomocniElementZaDialog.opis"
            ...
            <q-dialog v-model="dialogZaPostavkeTrenazneVezbe">
              <q-card style="width: 1400px; max-width: 100vw;">
                <q-card-section class="q-pa-md" style="text-align:center">
                  ...
                  <div class="text-h6" v-html="naslovTrenaze"></div>
                  <q-btn
                    :label="$t('trainings.seeDescription')"
                    color="primary"
                    @click="procitajOpis = true"
                  />
                </q-card-section>
                ...
                <q-card-section class="q-pt-none row">
                  <q-card-section class="q-pa-md  col-3">
                    ...
                    <q-btn
                      style="width: 100px; margin: 2.5px"
                      color="primary"
                      :label="$t('trainings.everybody')"
                      @click="
                    ...
                    />
                    <q-btn
                      style="width: 295px; margin: 2.5px; color: black"
                      icon="person"
                      :label="$t('trainings.players')"
                      @click="otvoriDialogZaIzborIgracaZaVezbu()"
                    />
                    <!-- <q-select
                        use-input
                        hide-selected
                    ...
                    <q-scroll-area style="height: 350px; max-width: 300px;">
                      <q-list bordered separator style="width: 300px">
                        <q-item
                          clickable
                          v-ripple
                          v-for="(e, index) in igraciIzabraniPrivremeno"
                          :key="index"
                          :style="{
                            backgroundColor:
                        ...
                        >
                          <q-item-section
                            >{{ e.ime }} {{ e.prezime }}</q-item-section
                          >
                          <q-item-section avatar>
                            <q-icon
                              color="primary"
                              name="delete"
                              @click="obrisiVezanog(pomocniElementZaDialog, e)"
                            />
                          </q-item-section>
                        </q-item>
                      </q-list>
                    ...
                    <q-item style="margin-bottom: 5px">
                      ...
                      >
                        <q-select
                          borderless
                          class="selektKlass"
                          v-model="izabranBalans"
                          :options="optionBalans"
                          ref="select4"
                    ...
                    <q-item style="margin-bottom: 5px">
                      ...
                      >
                        <q-select
                          borderless
                          class="selektKlass"
                          v-model="izabranProstor"
                          :options="optionProstor"
                          ref="select7"
                  ...
                  <q-card-section class="q-pa-md q-ma-md col-3">
                    ...
                    <q-radio
                      name="Mentalno Opterećenje"
                      v-model="izabranaOpcijaOpterecenja"
                      val="M"
                      :label="$t('trainings.mentalLoad')"
                      style="width: 100%;"
                    >
                      <span
                        style="font-weight: bold"
                        v-if="izabranoMentalnoOpterecenje != null"
                      >
                        ({{
                          borgovaSkala.filter(
                            e => e.value == izabranoMentalnoOpterecenje
                          )[0].label
                        }})
                      </span></q-radio
                    >
                    <q-radio
                      name="Fizičko Opterećenje"
                      v-model="izabranaOpcijaOpterecenja"
                      val="F"
                      :label="$t('trainings.physicalExercise')"
                      style="width: 100%;"
                    >
                      <span
                        style="font-weight: bold"
                        v-if="izabranoFizickoOpterecenje != null"
                      >
                        ({{
                          borgovaSkala.filter(
                            e => e.value == izabranoFizickoOpterecenje
                          )[0].label
                        }})
                      </span></q-radio
                    >
                    <q-radio
                      ...
                      v-model="izabranaOpcijaOpterecenja"
                      val="T"
                      :label="$t('trainings.TeTaLevel')"
                      style="width: 100%;"
                    >
                      <span
                        style="font-weight: bold"
                        v-if="izabranTeTaNivo != null"
                      >
                        ({{
                          borgovaSkala.filter(e => e.value == izabranTeTaNivo)
                            .length > 0
                            ? borgovaSkala.filter(
                                e => e.value == izabranTeTaNivo
                              )[0].label
                            : ""
                        }})
                      </span></q-radio
                    ...
                    <q-btn
                      style="background-color: #ddd;width: 50px; height: 50px; margin: 1px;"
                    />
                    <q-btn
                      color="primary"
                      @click="promeniVrednostOpterecenju(entry)"
                      @mouseenter="labelOpterecenja = entry.label"
                      @mouseleave="labelOpterecenja = ''"
                      v-for="entry in borgovaSkala"
                      :key="entry.label"
                ...
                <q-card-actions align="right">
                  ...
                  <q-btn
                    flat
                    :label="$t('administration.user.save')"
                    @click="sacuvajVezaneIgrace(pomocniElementZaDialog)"
                    color="primary"
                    :disable="dozvolaZaIzmenu"
                  />
                </q-card-actions>
            ...
            <q-card-section style="position:fixed; bottom:30px;">
              <q-btn
                style="margin:5px;"
                :label="$t('trainings.obrisiTimeline')"
                @click="obrisiTimeline()"
                class="dugmeNewNesto2"
                ><span
              ...
              <q-btn
                style="margin:5px;"
                :label="$t('trainings.dodajTimeline')"
                @click="sviTimelinovi.push({ x: 0, y: 0, width: 0, height: 0 })"
                class="dugmeNewNesto2"
                ><span
                  style="font-size: 23px; font-weight: 400; padding-left: 5px;"
                >
          ...
          <q-card-section
            class="col-3"
            style="background: #f5f8fb; color: #323b62; overflow: auto;"
          >
            ...
            <q-card
              v-for="(element, index) in kopijaDataVezbe"
              :key="element.ident"
              flat
              bordered
              :id="'tv' + element.ident"
              ...
              :style="{ top: 0 + index * 10 + 'px' }"
              @mousedown="onMouseDown(element)"
            >
              <q-card-section
                style="padding: 10px 0px; height: 40px; background: #e5edf4;"
              >
                <div
                  style="
                    padding: 0 5%;
        ...
        <q-card-section style="position:fixed; left:60%; bottom:30px;">
          <q-btn
            round
            style="margin:5px; color: #3b5d99; background: #f5f8fb;"
            type="submit"
            size="20px"
            v-close-popup
          >
          ...
          <q-btn
            ...
            @click="snimiPromeneElemenatabloka1()"
            type="submit"
            icon="save"
            size="20px"
            :disable="dozvolaZaIzmenu"
            ...
            <q-card-section class="q-pt-none">
              <q-form class="q-gutter-md">
                <q-list>
                  ...
                  <q-item>
                    <q-item-section
                      style="flex-direction: row; max-height: 70vh; overflow: auto;"
                    >
                      <div
                        v-for="(igrac, index) in igraciSelekcije"
                        :key="index"
                        style="
                          width: 23%;
        ...
        <q-dialog persistent v-model="dialogZaIzborIgracaZaVezbu">
          <q-card style="width: 1000px; max-width: 90vw;">
              ...
              <q-form class="q-gutter-md">
                <q-list>
                  ...
                  <q-item>
                    ...
                    >
                      <div
                        v-for="(igrac, index) in prisutniIgraciNaTreningu"
                        :key="index"
                        style="
                          width: 23%;
                          background-color:#e5edf4;
            ...
            <q-card-actions align="right" class="bg-white text-teal">
              <q-btn
                :label="$t('administration.user.close')"
                @click="close"
                type="submit"
                color="primary"
                v-close-popup
    ...
    <q-dialog v-model="potvrdiPromenu" persistent>
      <q-card>
        ...
        <q-card-actions align="right">
          ...
          />
          <q-btn
            v-if="produziUtakmicuTest"
            flat
            :label="$t('trainings.continue')"
            color="primary"
            v-close-popup
            @click="produziUtakmicu()"
            :disable="dozvolaZaIzmenu"
          />
          <q-btn
            v-if="skratiUtakmicuTest"
            flat
            :label="$t('trainings.continue')"
            color="primary"
            v-close-popup
            @click="skratiUtakmicu()"
            :disable="dozvolaZaIzmenu"
          />
          <q-btn
            v-if="povecajDialogTest"
            flat
            :label="$t('trainings.continue')"
            color="primary"
            v-close-popup
          ...
          />
          <q-btn
            v-if="snimiPromeneTest"
            flat
            :label="$t('trainings.continue')"
            color="primary"
            v-close-popup
            @click="snimiPromeneElemenatabloka()"
            :disable="dozvolaZaIzmenu"
          />
        </q-card-actions>
      </q-card>
      ...
      self.dataVezbe.forEach(function(entry) {
        if (self.pretraga.includes("*")) {
          ...
          self.pretraga.split("*").forEach(entry2 => {
            if (!entry.naziv.toLowerCase().includes(entry2.toLowerCase()))
              missCounter += 1;
          });

          if (missCounter == 0) self.kopijaDataVezbe.push(entry);
        } else if (entry.naziv.toLowerCase().includes(self.pretraga.toLowerCase())) self.kopijaDataVezbe.push(entry);
      });
    },
    azurirajProzvane() {
        ...
        if (
          ...
          document.getElementById(
            ...
            document.getElementById("timelineBroj" + 0).getBoundingClientRect()
              .left -
            25 +
            "px"; // TODO: 25 je magican broj za gresku pri poravnjavanju
        }
