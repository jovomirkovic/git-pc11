  ...
  <q-page class="q-pa-sm">
    ...
    >
      <template v-slot:top-right="props">
        <q-btn
          @click="otvordeDialog()"
          :label="$t('administration.principlesOfTheGame.newPrinc')"
        ...
        <q-card-section class="q-pt-none">
          <q-form class="q-gutter-md">
            <q-list>
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP1" class="placeholder">{{
                      $t("administration.principlesOfTheGame.name")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP2" class="placeholder">{{
                      $t("administration.principlesOfTheGame.desc")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
              <q-item
                class="column"
                style="border: 1px solid #323b623a; border-radius: 4px; margin: 20px; padding: 20px 20px 10px 20px"
              >
                <q-item-section
                ...
                >
                  <q-select
                    ...
                    @blur="
                      spustiPlaceholder(
                        'Span-SL1',
                        editedItem.identGrupeElementaTaktike
                      )
                    "
                  >
                    <template
                      v-if="editedItem.identGrupeElementaTaktike"
                      v-slot:append
                    >
                      <q-icon
                        name="cancel"
                  ...
                  <span
                    ...
                    >{{
                      $t("administration.principlesOfTheGame.tacElem")
                    }}</span
                  >
                </q-item-section>
                <q-item-section class="custom-field one" style="margin: 0px">
                  <q-select
                    ...
                    @blur="
                      spustiPlaceholder(
                        'Span-SL2',
                        editedItem.identElementaTaktike
                      )
                    "
                  >
                    <template
                      v-if="editedItem.identElementaTaktike"
                      v-slot:append
                    >
                      <q-icon
                        name="cancel"
                  ...
                  <span
                    ...
                    class="placeholder placeholder1"
                    >{{
                      $t("administration.principlesOfTheGame.grpItems")
                    }}</span
                  >
                </q-item-section>
              </q-item>
              ...
              >
                ...
                >
                  <q-select
                    ...
                    @input="
                      popniPlaceholder('Span-SL3');
                      getDataStavke(
                        editedItem.identPrimarneGrupeElemetaTehnike
                      );
                    "
                    @blur="
                      spustiPlaceholder(
                  ...
                  >
                    <template
                      v-if="editedItem.identPrimarneGrupeElemetaTehnike"
                      v-slot:append
                    >
                      <q-icon
                        name="cancel"
                  ...
                  <span
                    ...
                    class="placeholder placeholder1"
                    >{{
                      $t("administration.principlesOfTheGame.grpPrimElem")
                    }}</span
                  >
                </q-item-section>
                <q-item-section class="custom-field one" style="margin: 0px">
                  <q-select
                    ...
                    @blur="
                      spustiPlaceholder(
                        'Span-SL4',
                        editedItem.identPrimarnogElementaTehnike
                      )
                    "
                  >
                    <template
                      v-if="editedItem.identPrimarnogElementaTehnike"
                      v-slot:append
                    >
                      <q-icon
                        name="cancel"
                  ...
                  <span
                    ...
                    class="placeholder placeholder1"
                    >{{
                      $t("administration.principlesOfTheGame.primElem")
                    }}</span
                  >
                </q-item-section>
              </q-item>
                ...
                >
                  <q-select
                    ...
                    @input="
                      ...
                      getDataStavke(
                        editedItem.identSekundarneGrupeElemetaTehnike
                      );
                    "
                    @blur="
                      spustiPlaceholder(
                  ...
                  >
                    <template
                      v-if="editedItem.identSekundarneGrupeElemetaTehnike"
                      v-slot:append
                    >
                      <q-icon
                        name="cancel"
                  ...
                  <span
                    ...
                    class="placeholder placeholder1"
                    >{{
                      $t("administration.principlesOfTheGame.grpSecElem")
                    }}</span
                  >
                </q-item-section>
                <q-item-section class="custom-field one" style="margin: 0px">
                  <q-select
                    ...
                    @blur="
                      spustiPlaceholder(
                        'Span-SL6',
                        editedItem.identSekundarnogElementaTehnike
                      )
                    "
                  >
                    <template
                      v-if="editedItem.identSekundarnogElementaTehnike"
                      v-slot:append
                    >
                      <q-icon
                        name="cancel"
                  ...
                  <span
                    ...
                    class="placeholder placeholder1"
                    >{{
                      $t("administration.principlesOfTheGame.secElem")
                    }}</span
                  >
                </q-item-section>
              </q-item>
...
export default {
  ...
  methods: {
    ...
    getDataStavke(a) {
      let linkStr =
        this.$apiPutanja + "/baza-tehnike-sifrarnik-stavke?identGrupe=" + a;
      this.loadingUtakmice = true;
      debugger;
      this.$axios
        .get(linkStr, {
    ...
    //........................................
    getDataStavkeTaktike() {
      if (this.editedItem.identGrupeElementaTaktike == null) return;
      let linkStr =
        this.$apiPutanja +
        "/baza-taktike-sifrarnik-stavke?identGrupe=" +
        this.editedItem.identGrupeElementaTaktike;
      debugger;
      this.$axios
        .get(linkStr, {
          headers: {
    ...
    addRow() {
      ...
      if (this.editedItem.identElementaTaktike == null)
        this.editedItem.identElementaTaktike = "";
      if (this.editedItem.identGrupeElementaTaktike == null)
        this.editedItem.identGrupeElementaTaktike = "";
      if (this.editedItem.identPrimarneGrupeElemetaTehnike == null)
        this.editedItem.identPrimarneGrupeElemetaTehnike = "";
      if (this.editedItem.identPrimarnogElementaTehnike == null)
        this.editedItem.identPrimarnogElementaTehnike = "";
      if (this.editedItem.identSekundarneGrupeElemetaTehnike == null)
        this.editedItem.identSekundarneGrupeElemetaTehnike = "";
      if (this.editedItem.identSekundarnogElementaTehnike == null)
        this.editedItem.identSekundarnogElementaTehnike = "";
