        ...
        >
          <template v-slot:top-right="props">
            <q-btn
              ...
              @click="otvordeDialog()"
              :label="$t('administration.tactics.items.new1Item')"
                    ...
                    <q-item-section>
                      ...
                      <label class="custom-field one">
                        ...
                        <span id="Span-IP1" class="placeholder">{{
                          $t("administration.tactics.items.name")
                        }}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      <q-editor
                        ...
                        :label="$t('administration.tactics.items.desc')"
                        min-height="5rem"
                      />
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      ...
                      <label class="custom-field one">
                        ...
                        <span class="placeholder">{{
                          $t("administration.tactics.items.video")
                        }}</span>
                      </label>
                    </q-item-section>
                  </q-item>
...
export default {
  ...
  methods: {
    ...
    deleteData(item) {
      debugger;
      let linkStr =
        this.$apiPutanja + "/baza-taktike-sifrarnik-stavke/" + item.ident;
      var self = this;
      debugger;
      this.$axios
        .delete(linkStr, {
