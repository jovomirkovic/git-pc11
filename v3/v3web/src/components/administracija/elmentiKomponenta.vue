  ...
  <q-page class="q-pa-sm">
    ...
    >
      ...
      <template v-slot:body-cell="props">
        ...
        <q-td
          :props="props"
          v-else-if="props.value == props.row.sifra"
                ...
                <q-item-section>
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP1" class="placeholder">{{
                      $t("administration.elementsOfTheGame.psw")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP2" class="placeholder">{{
                      $t("administration.elementsOfTheGame.elemName")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP3" class="placeholder">{{
                      $t("administration.elementsOfTheGame.elemDesc")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
...
export default {
  ...
  methods: {
    ...
    putData() {
      ...
      let linkStr =
        this.$apiPutanja +
        "/element-fudbalske-igre-sifrarnik/" +
    ...
    deleteData(item) {
      debugger;
      let linkStr =
        this.$apiPutanja + "/element-fudbalske-igre-sifrarnik/" + item.ident;
      var self = this;
      debugger;
      this.$axios
        .delete(linkStr, {
    ...
    addRow() {
      ...
      if (this.editedItem.sifra == null || this.editedItem.sifra == "")
        sveOK = false;
    ...
    deleteItem(item) {
      ...
      let obj = {
        ...
        customConfirmBtnText: this.$t(
          "administration.elementsOfTheGame.txtYes"
        ),
