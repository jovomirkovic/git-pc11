  ...
  <q-page class="q-pa-sm">
    ...
    >
      ...
      <template v-slot:body-cell="props">
        <q-td
          v-if="props.row.roles == props.value"
        ...
        <q-td
          v-else-if="props.row.userName == props.value"
          @click="otvoriPreviewDialog(props.row)"
        >
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP1" class="placeholder">{{
                      $t("administration.user.username")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP2" class="placeholder">{{
                      $t("administration.user.password")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
              ...
              <q-item @click="this.proveri()">
                ...
                >
                  ...
                  <span
                    ...
                    >{{ $t("administration.user.role") }}</span
                  >
                </q-item-section>
              </q-item>
...
export default {
  ...
  methods: {
    ...
    deleteItem(item) {
      if (item == undefined) var item = this.editedItem;
      console.log(item);
