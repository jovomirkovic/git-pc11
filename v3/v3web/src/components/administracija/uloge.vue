  ...
  <q-page class="q-pa-sm">
    ...
    >
      ...
      <template v-slot:body-cell="props">
        <q-td :props="props" v-if="props.value == props.row.action">
          <div class="q-gutter-sm">
            <q-btn
              ...
              round
              dense
              style="background-color: #e5edf4; color: #3b5d99"
              icon="edit"
            >
              <q-tooltip>
                {{ $t("table.editData") }}
        ...
        <q-td
          :props="props"
          v-else-if="props.row.uloga == props.value"
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    <q-input
                      ...
                      @blur="
                        spustiPlaceholder('Span-IP2', editedItem.telesnaVisina)
                      "
                      ref="input2"
                      :rules="[
                        (val) =>
                    ...
                    <span id="Span-IP2" class="placeholder">{{
                      $t("administration.roles.roleName")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
...
export default {
  ...
  methods: {
    ...
    putData() {
      ...
      let linkStr = this.$apiPutanja + "/roles/" + this.editedItem.uloga;
    ...
    deleteData(item) {
      debugger;
      let linkStr = this.$apiPutanja + "/roles/" + item.uloga;
      var self = this;
      debugger;
      this.$axios
        .delete(linkStr, {
