  ...
  <q-page class="q-pa-sm">
    ...
    >
      <template v-slot:top-right="props">
        <q-btn
          @click="otvordeDialog()"
          :label="$t('administration.tactics.groups.newElem')"
                ...
                <q-item-section>
                  ...
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP1" class="placeholder">{{
                      $t("administration.tactics.groups.grpName")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
...
export default {
  ...
  methods: {
    ...
    deleteData(item) {
      debugger;
      let linkStr =
        this.$apiPutanja + "/baza-taktike-sifrarnik-grupa/" + item.ident;
      var self = this;
      debugger;
      this.$axios
        .delete(linkStr, {
