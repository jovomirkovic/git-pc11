                ...
                <q-item-section>
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP1" class="placeholder">{{
                      $t("administration.technique.groups.grpName")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
...
export default {
  ...
  methods: {
    ...
    deleteData(item) {
      debugger;
      let linkStr =
        this.$apiPutanja + "/baza-tehnike-sifrarnik-grupa/" + item.ident;
      var self = this;
      debugger;
      this.$axios
        .delete(linkStr, {
    ...
    addRow() {
      ...
      if (this.editedItem.grupa == null || this.editedItem.grupa == "")
        sveOK = false;
