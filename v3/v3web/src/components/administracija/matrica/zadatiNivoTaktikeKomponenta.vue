<template>
  <q-page class="q-pa-sm">
    <q-table
      :title="$t('administration.tactics.setpointMatrix.setTactics')"
      :data="data"
                ...
                <q-item-section>
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP1" class="placeholder">{{
                      $t("administration.tactics.setpointMatrix.group")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP2" class="placeholder">{{
                      $t("administration.tactics.setpointMatrix.item")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
              ...
              <q-item>
                <q-item-section>
                  <q-input
                    ...
                    v-model="editedItem.grupa"
                    :label="$t('administration.tactics.setpointMatrix.group')"
                  ></q-input>
                </q-item-section>
              </q-item>
              ...
              <q-item style="margin-bottom: 30px">
                <q-item-section>
                  <q-input
                    ...
                    style="background: #f5f8fb; color: #323b62; height: 45px; border-radius: 5px; padding-left: 14px !important;"
                    v-model="editedItem.naziv"
                    :label="$t('administration.tactics.setpointMatrix.item')"
                  ></q-input>
                </q-item-section>
              </q-item>
...
export default {
  ...
  methods: {
    ...
    postData() {
      ...
      this.$axios
        ...
        .then(function(response) {
          ...
          self.$q.notify({
            message: self.$t(
              "administration.tactics.setpointMatrix.msgPositive"
            ),
            color: "green"
          });
        })
    ...
    deleteData(item) {
      debugger;
      let linkStr =
        this.$apiPutanja + "/element-taktike-sifrarnik/" + item.ident;
      var self = this;
      debugger;
      this.$axios
        .delete(linkStr, {
