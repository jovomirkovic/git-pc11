export default {
  main: {
    ...
    treninzi: "Trainings",
    trenezneVezbe: "Training exercises",
    utakmice: "Matches",
    podaciOIgri: "Game Info",
    taktickiElementi: "Tactical elements",
    tehnickiElementi: "Technical elements",
    principiIgre: "Game principals",
    medicinskiKarton: "Medical record",
    povredeIgraca: "Athlete injuries",
    strucniTim: "Coaching staff",
    igraci: "Athletes",
    tenanti: "Tenants",
    ...
    playerInjuries: "Athlete injuries",
    players: "Athletes",
    labeljezik: "Language",
  ...
  administration: {
    ...
    teams: {
      ...
      enterTeamName: "Please enter section name",
      pickAge: "Choose section age",
      pickAgePls: "Please choose section age",
      pickCompAge: "Choose a competitive age for section",
      pickCompAgePls: "Please choose a competitive age for section",
      pickPlacePls: "Please choose a place for section",
      place: "Place",
      age: "Age",
      dateReg: "Date of registration",
      save: "Save",
      cancel: "Cancel",
      msgPositive: "New section successfully added!",
      msgNeg: "New section NOT successfully added!",
      msgChange: "Section data changed successfully!",
      msgNotChange: "Section data NOT changed successfully!",
    ...
    professionalStaff: {
      ...
      save: "Save",
      cancel: "Cancel",
      msgPositive: "New section member successfully added!",
      msgNeg: "New section member NOT successfully added!",
      msgChange: "User data changed successfully!",
      msgNotChange: "User data NOT changed successfully!",
      msgDel: "User data deleted successfully!",
      msgDelConf: "Do you really want to delete the current record?",
    ...
    players: {
      ...
      players: "Athletes",
      newPlayer: "New athlete",
      sysUsers: "Adding athletes as system users",
      name: "Name",
      surname: "Surname",
      nick: "Nickname",
      gender: "Gender",
      ...
      cancel: "Cancel",
      msgPositive: "New section member successfully added!",
      msgPositivePly: "The athlete has been successfully added as a user!",
      msgNeg: "User role NOT successfully added!",
      msgChange: "User data changed successfully!",
      msgNotChange: "User data NOT changed successfully!",
      ...
      msgDel: "User data deleted successfully!",
      msgDelConf: "Do you really want to delete the current record?",
      msgConf: "Do you really want to add this athlete as a system user?",
      msgPrtSc: "The browser does not allow saving files ...",
    ...
    connections: {
      ...
      saveTeamData: "Save section data",
      ...
      defPosition: "Defining positions for the athlete",
      transferDate: "Date of transfer",
      playerDel: "Deleting athletes from the selection",
      playerLeave: "Athlete transfer date from the selection",
      ...
      surname: "Surname",
      type: "Type",
      msgPlayerInfoPos: "Enter position information for the athlete: ",
      msgPrimPos: "You have not selected a primary athlete position: ",
      msgSecPos: "You have not selected a secondary position for the athlete: ",
      msgTerPos: "You have not selected a tertiary position for the athlete: ",
      msgEnterData:
        "Section data was NOT saved successfully! Make sure you have entered positions for all athletes.",
      msgPositive: "Section data successfully added!",
      msgNo: "You have not entered any positions!",
      msgDel: "User data deleted successfully!",
      msgDelConf: "Do you really want to delete the current record?",
      msgEnterRoleName: "Enter a role name!",
      msgLeft: "The athlete has successfully left the selection!",
      msgLeftNot:
        "The athlete did NOT successfully leave the selection! Check the entered data.",
      msgPositivePly: "The athlete has been successfully added as a user!",
      msgNeg: "User role NOT successfully added!",
      msgChange: "User data changed successfully!",
      msgNotChange: "User data NOT changed successfully!",
  ...
  trainings: {
    ...
    selectedPlayer: "Selected athlete",
    selectPlayer: "Select athlete",
    browsePlayers: "Browse athletes",
    ...
    naslovPridruzivanje: "Adding athletes to practice",
    ...
    twoExercises: "Athlete cannot be on two exercises at the same time:",
  ...
  matches: {
    ...
    selectionOfPlayersInFormations: "Selection of athletes and formations",
    reset: "Reset",
    players: "Athletes",
    ...
    goal: "Goal",
    log: "Log",
    assigningNumbersToPlayers: "Assigning numbers to athletes",
    ...
    playersNeedToHaveDifferentNumbers:
      "Athletes need to have different numbers",
    ...
    playerPlayingStatus: "Athlete status",
    bench: "On the bench",
    field: "On the field",
    lastName: "Last name",
    positions: "Positions",
    ...
    enterPlayerNumber: "Enter athlete number",
    ...
    playerSubstitutionSaved: "Athlete substitution saved",
    playerSubstitutionFailed: "Athlete substitution not saved",
  ...
  players: {
    ...
    playerRating: {
      ...
      browsePlayers: "Browse athletes",
      rowsPerPage: "Rows per page:",
      pca: "Athlete capacity assessment",
      newAssessment: "New",
      search: "Search",
      exitFullscreen: "Exit Full Screen Mode",
      enterFullscreen: "Enter Full Screen Mode",
      ...
      fkCZ: "National section",
      superliga: "National League",
      prvaLiga: "Second League",
      olympicMedalist: "Olympic medalist",
      olympicParticipation: "Olympic Participation",
      nationalRecord: "National record",
      identifiedTalent: "Identified Talent",
    },
    ...
    finance: {
      ...
      dataOnFinancialInvestmentsInPlayers:
        "Data on financial investments in athletes",
      selectedPlayer: "Selected athlete",
      selectPlayer: "Select athlete",
      browsePlayers: "Browse athletes",
      rowsPerPage: "Rows per page:",
      ...
      measurementDataDeletedSuccessfully:
        "Measurement data deleted successfully!",
      mesurement: "Measurement",
      compensationPaidForThePlayer: "Compensation paid for the athlete",
      signatureFee: "Signature fee",
      theClubsPercentageInThePlayersLegalBusiness:
        "The club’s percentage in the athletes legal business",
    ...
    guardianAngel: {
      ...
      playerTracking: "Athlete tracking",
      selectedPlayer: "Selected athlete",
      selectPlayer: "Select athlete",
      browsePlayers: "Browse athletes",
      rowsPerPage: "Rows per page:",
  ...
  promenaIgraca: {
    izaberiTim: "Choose a athlete",
    izaberiTimIIgraca: "Choose an section and a athlete",
    timovi: "Sports sections",
    igraci: "Athletes",
    tim: "Section",
  },
  table: {
