<template>
  <q-page class="q-pa-sm container">
    ...
    >
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'users') != undefined &&
            menuItems
              .find(e => e.label == 'users')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'roles') != undefined &&
            menuItems
              .find(e => e.label == 'roles')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'teams') != undefined &&
            menuItems
              .find(e => e.label == 'teams')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'professionalStaff') != undefined &&
            menuItems
              .find(e => e.label == 'professionalStaff')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'playersLabel') != undefined &&
            menuItems
              .find(e => e.label == 'playersLabel')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'connections') != undefined &&
            menuItems
              .find(e => e.label == 'connections')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'elementsOfTheGame') != undefined &&
            menuItems
              .find(e => e.label == 'elementsOfTheGame')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'technique') != undefined &&
            menuItems
              .find(e => e.label == 'technique')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'tactics') != undefined &&
            menuItems
              .find(e => e.label == 'tactics')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'principlesOfTheGame') != undefined &&
            menuItems
              .find(e => e.label == 'principlesOfTheGame')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
      ...
      <q-tab
        v-if="
          menuItems.find(e => e.label == 'testData') != undefined &&
            menuItems
              .find(e => e.label == 'testData')
              .roles.some(item => userRoles.includes(item))
        "
        no-caps
        label=""
...
export default {
  ...
  props: ["selektovaniIgrac", "menuItems", "userRoles"],
  data() {
    return {
      tab: "tab-timovi",
  ...
  mounted() {
    ...
    if (
      this.menuItems.find(e => e.label == "users") != undefined &&
      this.menuItems
        .find(e => e.label == "users")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-korisnici";
      this.korisniciT = true;
    } else if (
      this.menuItems.find(e => e.label == "roles") != undefined &&
      this.menuItems
        .find(e => e.label == "roles")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      ...
      this.menuItems.find(e => e.label == "teams") != undefined &&
      this.menuItems
        .find(e => e.label == "teams")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      ...
      this.menuItems.find(e => e.label == "professionalStaff") != undefined &&
      this.menuItems
        .find(e => e.label == "professionalStaff")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-strucniTim";
      this.profT = true;
    } else if (
      this.menuItems.find(e => e.label == "playersLabel") != undefined &&
      this.menuItems
        .find(e => e.label == "playersLabel")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      ...
      this.menuItems.find(e => e.label == "connections") != undefined &&
      this.menuItems
        .find(e => e.label == "connections")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-veze";
      this.konekcijeT = true;
    } else if (
      this.menuItems.find(e => e.label == "elementsOfTheGame") != undefined &&
      this.menuItems
        .find(e => e.label == "elementsOfTheGame")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-elementi";
      this.elemT = true;
    } else if (
      this.menuItems.find(e => e.label == "technique") != undefined &&
      this.menuItems
        .find(e => e.label == "technique")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-tehnika";
      this.tehnikaT = true;
    } else if (
      this.menuItems.find(e => e.label == "tactics") != undefined &&
      this.menuItems
        .find(e => e.label == "tactics")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-taktika";
      this.taktikaT = true;
    } else if (
      this.menuItems.find(e => e.label == "principlesOfTheGame") != undefined &&
      this.menuItems
        .find(e => e.label == "principlesOfTheGame")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-principiIgre";
      this.principiT = true;
    } else if (
      this.menuItems.find(e => e.label == "testData") != undefined &&
      this.menuItems
        .find(e => e.label == "testData")
        .roles.some(item => this.userRoles.includes(item))
    ) {
      this.tab = "tab-podaciOTestovima";
      this.testT = true;
    }
  },
  watch: {
  ...
  methods: {
    ...
    getData() {
      ...
      if (1 == 1) {
        //ovde treba proveriti da li je ulogovani korisnik admin
        window.$userIsAdmin = true;
