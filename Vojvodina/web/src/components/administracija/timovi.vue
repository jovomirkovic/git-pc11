  ...
  <q-page class="q-pa-sm">
        ...
        >
          ...
          <template v-slot:body-cell="props">
            ...
            <q-td :props="props" v-else-if="props.value == props.row.imeTima"  @click="otvoriPreviewDialog(props.row)">
                ...
                <q-list>
                  <q-item>
                    <q-item-section>
                      ...
                      <label class="custom-field one">
                        ...
                        <span id="Span-IP1" class="placeholder">{{$t('administration.teams.teamName')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section class="custom-field one">
                      ...
                      />
                  <span @click="$refs.select1.showPopup()" id="Span-SL1" class="placeholder placeholder1">{{$t('administration.teams.pickAge')}}</span>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section class="custom-field one">
                      <q-select
                        ...
                        @blur="spustiPlaceholder('Span-SL2', editedItem.rangTakmicenja)"
                        :rules="[
                          (val) =>
                            (val !== null && val !== '') ||
                      ...
                      />
                  <span @click="$refs.select2.showPopup()" id="Span-SL2" class="placeholder placeholder1">{{$t('administration.teams.pickCompAge')}}</span>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      <label class="custom-field one">
                        ...
                        />
                        <span id="Span-IP2" class="placeholder">{{$t('administration.teams.place')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.teams.teamName')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        <span class="placeholder">{{$t('administration.teams.place')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                </q-list>
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          field: "uzrastTima",
          sortable: true,
          sort: (a, b) => parseInt(a.replace("U", ""), 10) - parseInt(b.replace("U", ""), 10)
        },
        {
          name: "mesto",
          align: "left",
...
debugger
    ...
    addRow() {
      ...
      if(this.editedItem.imeTima == null || this.editedItem.imeTima == '')  sveOK = false
      if(this.editedItem.uzrastTima == null || this.editedItem.uzrastTima == '')  sveOK = false
      if(this.editedItem.rangTakmicenja == null || this.editedItem.rangTakmicenja == '')  sveOK = false
