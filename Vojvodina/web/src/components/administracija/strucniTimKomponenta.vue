  ...
  <q-page class="q-pa-sm">
        ...
        >
          ...
          <template v-slot:body-cell="props">
            ...
            <q-td :props="props" v-else-if="props.value == props.row.roles"  @click="otvoriPreviewDialog(props.row)">
              <div>
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      <label class="custom-field one">
                        ...
                        <span id="Span-IP1" class="placeholder">{{$t('administration.professionalStaff.name')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  <q-item>
                   <q-item-section>
                      <label class="custom-field one">
                        ...
                        <span id="Span-IP2" class="placeholder">{{$t('administration.professionalStaff.surname')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section class="custom-field one">
                      ...
                      <span @click="$refs.select1.showPopup()" id="Span-SL1" class="placeholder placeholder1">{{$t('administration.professionalStaff.role')}}</span>
                ...
                <!-- v-close-popup -->
                  ...
                  <q-item>
                    <q-item-section class="custom-field one">
                      ...
                      />
                      <span @click="$refs.select2.showPopup()" id="Span-SL2" class="placeholder placeholder1">{{$t('administration.professionalStaff.license')}}</span>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section class="custom-field one">
                      <q-select
                        ...
                        @blur="spustiPlaceholder('Span-SL3', editedItem.obrazovanje)"
                      />
                      <span @click="$refs.select3.showPopup()" id="Span-SL3" class="placeholder placeholder1">{{$t('administration.professionalStaff.education')}}</span>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <q-input
                          ...
                          @blur="spustiPlaceholder('Span-IP3', editedItem.obrazovnaInstitucija)"
                        />
                      <span id="Span-IP3" class="placeholder">{{$t('administration.professionalStaff.educationInst')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section>
                      ...
                      type="number"
                          ...
                          @blur="spustiPlaceholder('Span-IP4', editedItem.stazUsportu)"
                        />
                        <span id="Span-IP4" class="placeholder">{{$t('administration.professionalStaff.sportInter')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  <q-item>
                    <q-item-section>
                      ...
                      type="number"
                          ...
                          @blur="spustiPlaceholder('Span-IP5', editedItem.stazUklubu)"
                        />
                        <span id="Span-IP5" class="placeholder">{{$t('administration.professionalStaff.clubInter')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                        <label class="custom-field one">
                          ...
                          :readonly="readonly"
                            ...
                            @blur="spustiPlaceholder('Span-IP6', editedItem.datumVazenjaUgovora)"
                            ref="input6"
                            mask="##/##/####"
                          ...
                          <span id="Span-IP6" class="placeholder">{{$t('administration.professionalStaff.contractExpiration')}}</span>
                        </label>
                    ...
                    <q-item-section>
                      ...
                      <label class="custom-field one">
                        <q-input
                          ...
                          @blur="spustiPlaceholder('Span-IP7', editedItem.ugovorenaZarada)"
                        />
                        <span id="Span-IP7" class="placeholder">{{$t('administration.professionalStaff.earnings')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item-section>
                    <label class="custom-field one datumInput">
                      <q-input
                        ...
                        @blur="spustiPlaceholder('Span-IP8', editedItem.vaznostPasosa)"
                        ref="input8"
                        :rules="[val => valiDate(val) || 'DD/MM/YYYY']"
                      >
                        <template v-slot:append>
                      ...
                      <span id="Span-IP8" class="placeholder">{{$t('administration.professionalStaff.passportImportance')}}</span>
                    </label>
                  ...
                  <q-item class="formular rasiri">
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span id="Span-IP9" class="placeholder">{{$t('administration.professionalStaff.passportNum')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                ...
                <q-list>
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.professionalStaff.name')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                   <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.professionalStaff.surname')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  <q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        readonly
                        v-model="editedItem.obrazovnaInstitucija"
                        :label="$t('administration.professionalStaff.educationInst')"/>
                      <span class="placeholder">{{$t('administration.professionalStaff.educationInst')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.professionalStaff.sportInter')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.professionalStaff.clubInter')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item-section class="formular ponisti" style="">
                        <label class="custom-field one">
                          ...
                          readonly
                          v-model="editedItem.datumVazenjaUgovora"
                          :label="$t('administration.professionalStaff.contractExpiration')"
                          />
                          <span class="placeholder">{{$t('administration.professionalStaff.contractExpiration')}}</span>
                        </label>
                  </q-item-section>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.professionalStaff.earnings')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item-section class="formular ponisti" style="">
                        <label class="custom-field one">
                          ...
                          readonly
                          v-model="editedItem.vaznostPasosa"
                          :label="$t('administration.professionalStaff.passportImportance')"
                          />
                          <span class="placeholder">{{$t('administration.professionalStaff.passportImportance')}}</span>
                        </label>
                  ...
                  <q-item>
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        readonly
                        v-model="editedItem.brojPasosa"
                        :label="$t('administration.professionalStaff.passportNum')"
                        />
                        <span class="placeholder">{{$t('administration.professionalStaff.passportNum')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
...
export default {
  data() {
    return {
      ...
      opcijeObrazovanje: [
        { label: this.$t('administration.professionalStaff.obrazovanjeOsnovno'), value: "Osnovno obrazovanje" },
        { label: this.$t('administration.professionalStaff.obrazovanjeSrednje'), value: "Srednje stručno obrazovanje" },
        { label: this.$t('administration.professionalStaff.obrazovanjeVisa'), value: "Viša školska ustanova" },
        { label: this.$t('administration.professionalStaff.obrazovanjeVisoka'), value: "Visoka školska ustanova" },
        { label: this.$t('administration.professionalStaff.obrazovanjeMaster'), value: "Master studije" },
        { label: this.$t('administration.professionalStaff.obrazovanjeDoktorske'), value: "Doktorske studije" },
      ],
      opcijeLicenca: [
        { label: this.$t('administration.professionalStaff.profiLicenca'), value: "PROFI licenca" },
        { label: this.$t('administration.professionalStaff.eliteLicenca'), value: "ELITE youth licenca" },
        { label: this.$t('administration.professionalStaff.licencaA'), value: "A licenca" },
        { label: this.$t('administration.professionalStaff.licencaB'), value: "B licenca" },
        { label: this.$t('administration.professionalStaff.licencaC'), value: "C licenca" },
        { label: this.$t('administration.professionalStaff.licencaD'), value: "D licenca" },
      ],
      customer: {},
      new_customer: false,
      dataPreview: false,
      ...
      columns: [
        ...
        },
        {
          ...
          field: "rolesOpisno",
          sortable: true,
          format: val => val.filter(e=> !e.includes("Professional staff")).join(", ")
        },
        {
          name: "obrazovanje",
          align: "left",
  ...
  mounted() {
    this.editedItem.datumVazenjaUgovora = new Date().toJSON().slice(0,10).replace(/-/g,'/');
  ...
  methods: {
    ...
    otvoriPreviewDialog(item){
      ...
      this.editedItem.datumVazenjaUgovora = this.editedItem.datumVazenjaUgovora.slice(0,10).replace(/-/g,'/').split("/")[2] + "/" + this.editedItem.datumVazenjaUgovora.slice(0,10).replace(/-/g,'/').split("/")[1] + "/" + this.editedItem.datumVazenjaUgovora.slice(0,10).replace(/-/g,'/').split("/")[0]
      this.editedItem.vaznostPasosa = this.editedItem.vaznostPasosa.slice(0,10).replace(/-/g,'/').split("/")[2] + "/" + this.editedItem.vaznostPasosa.slice(0,10).replace(/-/g,'/').split("/")[1] + "/" + this.editedItem.vaznostPasosa.slice(0,10).replace(/-/g,'/').split("/")[0]
      this.readonly = true;
        ...
        this.$axios
          ...
          .then(response => {
            ...
            self.data.forEach((entry, index) => {
              self.data[index].rolesOpisno = entry.rolesOpisno.filter(e=> !e.includes("Professional staff"))
              self.data[index].roles = entry.roles.filter(e=> !e.includes("ROLE_STRUCNI_STAB"))
            })
            console.log("this.data")
            console.log(self.data)
            debugger
...
debugger
    ...
    addRow() {
      ...
      if(this.editedItem.ime == null || this.editedItem.ime == '')  sveOK = false
      if(this.editedItem.prezime == null || this.editedItem.prezime == '')  sveOK = false
      if(this.editedItem.roles == null || this.editedItem.roles == '')  sveOK = false
...
deleteItem(item) {
      ...
      let obj = {
            ...
            useConfirmBtn: true,
            customConfirmBtnText: this.$t('administration.professionalStaff.txtYes'),
