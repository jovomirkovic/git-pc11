...
<!--           selection="single"
          ...
          <template v-slot:top-right="props">
            ...
            <q-input outlined dense class="dugmeSearch" debounce="300" v-model="filter">
          ...
          <template v-slot:body-cell="props">
            <q-td :props="props" v-if="props.value == props.row.action">
              <div class="q-gutter-sm">
                ...
                <q-btn
                  ...
                  icon="person"
                  >
                  <q-tooltip> {{$t('administration.players.sysUsers')}}</q-tooltip>
                </q-btn>
            ...
            <q-td :props="props" v-else-if="props.value == props.row.ime" @click="otvoriPreviewDialog(props.row)">
                  ...
                  <q-item class="formular1">
                    <q-item-section>
                      ...
                      :readonly="readonly"
                        ...
                        />
                        <span id="Span-IP0" class="placeholder">{{$t('administration.players.name')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>

                  <q-item class="formular1" style="position: relative; top: -5px; height: unset">
                    <q-item-section class="custom-field one">
                      ...
                      />
                      <span @click="$refs.select1.showPopup()" id="Span-SL1" class="placeholder placeholder1">{{$t('administration.players.gender')}}</span>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item class="formular1" style="padding-top: unset">
                   <q-item-section>
                      ...
                      :readonly="readonly"
                          ...
                          @blur="spustiPlaceholder('Span-IP1', editedItem.prezime)"
                          ref="input2"
                          :rules="[
                            (val) =>
                              (val !== null && val !== '') ||
                        ...
                        />
                        <span id="Span-IP1" class="placeholder">{{$t('administration.players.surname')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item class="formular1 ponisti" style="padding-top: 0px">
                    <label class="custom-field one datumInput">
                      ...
                      :readonly="readonly"
                        ...
                        @blur="spustiPlaceholder('Span-IP3', editedItem.datumRodjenja)"
                        ref="input4"
                        mask="##/##/####"
                      ...
                      <span id="Span-IP3" class="placeholder">{{$t('administration.players.birthDate')}}</span>
                    </label>
                  </q-item>
                  ...
                  <q-item class="formular1 ponisti">
                    <q-item-section>
                      ...
                      :readonly="readonly"
                          ...
                          @blur="spustiPlaceholder('Span-IP2', editedItem.nadimak)"
                          ref="input3"
                         />
                        <span id="Span-IP2" class="placeholder">{{$t('administration.players.nick')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item class="formular1">
                    <q-item-section>
                      ...
                      :readonly="readonly"
                          ...
                          @blur="spustiPlaceholder('Span-IP4', editedItem.drzavljanstvo)"
                          ref="input5"
                          :rules="[
                            (val) =>
                              (val !== null && val !== '') ||
                         ...
                         />
                        <span id="Span-IP4" class="placeholder">{{$t('administration.players.nationality')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                </div>
                <div class="desnaStranaSlika">
                  ...
                  <div >
                      ...
                      :readonly="readonly"
                            ...
                            />
                            <span id="Span-IP5" class="placeholder">{{$t('administration.players.address')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-IP6', editedItem.mobilni)"
                            />
                            <span id="Span-IP6" class="placeholder">{{$t('administration.players.mobile')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
<div style="width: 100%;">
                      ...
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-IP7', editedItem.email)"
                              :rules="[
                                (val) =>
                                  (val !== null && val !== '') ||
                            ...
                            />
                            <span id="Span-IP7" class="placeholder">{{$t('administration.players.email')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
</div>
                      <q-item class="formular rasiri" style="padding-top: -10px; height: unset">
                        <q-item-section class="custom-field one">
                          <q-select
                      :readonly="readonly"
                            borderless
                            ...
                            @blur="spustiPlaceholder('Span-SL2', editedItem.kakoJeDosaoUKlub)"
                            :rules="[
                              (val) =>
                                (val !== null && val !== '' && val.length > 0) ||
                          ...
                          />
                        <span @click="$refs.select2.showPopup()" id="Span-SL2" class="placeholder placeholder1">{{$t('administration.players.clubConn')}}</span>
                        </q-item-section>
                      </q-item>

                      <q-item class="formular rasiri ponisti" style="position: relative; top: 5px;">
                        <q-item-section>
                          <label class="custom-field one">
                            <q-input
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-IP8', editedItem.koGaJePreporucio)"
                              ref="input9"
                            />
                            <span id="Span-IP8" class="placeholder">{{$t('administration.players.recommendation')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-IP9', editedItem.brojPasosa)"
                              ref="input10"
                            />
                            <span id="Span-IP9" class="placeholder">{{$t('administration.players.passportNum')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      :readonly="readonly"
                        ...
                        placeholder=" "
                            ...
                            @blur="spustiPlaceholder('Span-IP10', editedItem.vaznostPasosa)"
                            ref="input11"
                            mask="##/##/####"
                            >
                            <!-- :rules="[val => valiDate(val) || 'DD/MM/YYYY']" -->
                      ...
                      :readonly="readonly"
                          ...
                          <span id="Span-IP10" class="placeholder">{{$t('administration.players.passportImportance')}}</span>
                        </label>
                      </q-item>


                      <p style="padding-top: 10px; text-align: center; margin-bottom: 10px;" class="ponisti"> {{$t('administration.players.fam')}} </p>

                      <q-item class="formular rasiri" style="padding-top: -5px; height: unset">
                        <q-item-section class="custom-field one">
                          <q-select
                      :readonly="readonly"
                            borderless
                            ...
                            @blur="spustiPlaceholder('Span-SL3', editedItem.saKimZivi)"
                          />
                          <span @click="$refs.select3.showPopup()" id="Span-SL3" class="placeholder placeholder1">{{$t('administration.players.livingWith')}}</span>
                        </q-item-section>
                      </q-item>

                      <q-item class="formular ponisti" style="width: 50%; position: relative; top: 5px;">
                        <q-item-section>
                          <label class="custom-field one">
                            <q-input
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-IP11', editedItem.brojDeceUPorodici)"
                            />
                            <span id="Span-IP11" class="placeholder">{{$t('administration.players.childNum')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      <q-item class="formular rasiri"  style="padding-top: -5px; height: unset">
                      ...
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-SL4', editedItem.obrazovanjeRoditelja)"
                            />
                            <span @click="$refs.select4.showPopup()" id="Span-SL4" class="placeholder placeholder1">{{$t('administration.players.parentEdu')}}</span>
                          </q-item-section>
                      </q-item>
                      ...
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-IP12', editedItem.kojeJeDetePoRedu)"
                            />
                            <span id="Span-IP12" class="placeholder">{{$t('administration.players.childorder')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      <q-item class="formular rasiri" style="padding-top: -5px; height: unset">
                      ...
                      :readonly="readonly"
                              ...
                              @blur="spustiPlaceholder('Span-SL5', editedItem.roditeljiZaposleni)"
                            />
                            <span @click="$refs.select5.showPopup()" id="Span-SL5" class="placeholder placeholder1">{{$t('administration.players.parentJob')}}</span>
                          </q-item-section>
                      </q-item>
            ...
            <q-card-actions :class="{ sakriDugmice: readonly }" align="center" class="bg-white text-teal ponisti">
              <q-btn
                  ...
                  <q-item class="formular">
                    <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.players.name')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item class="formular">
                   <q-item-section>
                      <label class="custom-field one">
                        ...
                        />
                        <span class="placeholder">{{$t('administration.players.surname')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                         ...
                         />
                        <span class="placeholder">{{$t('administration.players.nick')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <q-item class="formular ponisti" style="">
                    <label class="custom-field one">
                      ...
                      <input
                       ...
                       />
                      <span class="placeholder">{{$t('administration.players.birthDate')}}</span>
                    ...
                    <q-item-section>
                      <label class="custom-field one">
                        <input
                         ...
                         />
                        <span class="placeholder">{{$t('administration.players.nationality')}}</span>
                      </label>
                    </q-item-section>
                  </q-item>
                  ...
                  <div style="margin-top: -15px;">
                      ...
                      <q-item class="formular rasiri">
                        <q-item-section>
                          <label class="custom-field one">
                            ...
                            />
                            <span class="placeholder">{{$t('administration.players.address')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      <q-item class="formular rasiri">
                        <q-item-section>
                          <label class="custom-field one">
                            ...
                            />
                            <span class="placeholder">{{$t('administration.players.mobile')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      <q-item class="formular rasiri">
                        <q-item-section>
                          <label class="custom-field one">
                            ...
                            />
                            <span class="placeholder">{{$t('administration.players.email')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      <q-item class="formular rasiri ponisti">
                        <q-item-section>
                          <label class="custom-field one">
                            ...
                            />
                            <span class="placeholder">{{$t('administration.players.recommendation')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      <q-item class="formular rasiri">
                        <q-item-section>
                          <label class="custom-field one">
                            ...
                            />
                            <span class="placeholder">{{$t('administration.players.passportNum')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      <q-item class="formular ponisti" style="">
                        <label class="custom-field one unesiDatum">
                          ...
                          />
                          <span class="placeholder">{{$t('administration.players.passportImportance')}}</span>

                          <q-popup-proxy ref="qDateProxy1" transition-show="scale" transition-hide="scale">
                            <q-date v-model="editedItem.vaznostPasosa" @input="() => $refs.qDateProxy1.hide()"></q-date>
                          </q-popup-proxy>
                        </label>
                      </q-item>

                      <p style="padding-top: 5px; margin-bottom: 5px;" class="ponisti"> {{$t('administration.players.fam')}} </p>
                      <q-item class="formular">
                        <q-item-section>
                            <q-select
                              borderless
                      ...
                      <q-item class="formular">
                        <q-item-section>
                          <label class="custom-field one">
                            ...
                            />
                            <span class="placeholder">{{$t('administration.players.childNum')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
                      ...
                      <q-item class="formular">
                        <q-item-section>
                          <label class="custom-field one">
                            ...
                            />
                            <span class="placeholder">{{$t('administration.players.childorder')}}</span>
                          </label>
                        </q-item-section>
                      </q-item>
...
export default {
  ...
  data() {
    return {
      ...
      filter: "",
      listOptions:[
                { label: this.$t('administration.players.administrator'),  value: 'ROLE_ADMIN' },
                { label: this.$t('administration.players.trener'),  value: 'ROLE_TRENER' },
                { label: this.$t('administration.players.pomocniTrener'),  value: 'ROLE_POMTRENER' },
                { label: this.$t('administration.players.direktor'),  value: 'ROLE_MANAGER' },
                { label: this.$t('administration.players.igrac'),  value: 'ROLE_PLAYER' },
              ],
      opcijeZaKlub:[
                { label: this.$t('administration.players.preporukaMenadzer'),  value: 'PREPORUKA_MENADZERA' },
                { label: this.$t('administration.players.preporukaSkauta'),  value: 'PREPORUKA_SKAUTA' },
                { label: this.$t('administration.players.preporukaTrenera'),  value: 'PREPORUKA_TRENERA' },
                { label: this.$t('administration.players.selektivniTrening'),  value: 'SELEKTIVNI_TRENING' },
                { label: this.$t('administration.players.regionalniCentar'),  value: 'REGIONALNI_CENTAR' },
                { label: this.$t('administration.players.skolaFudbala'),  value: 'SKOLA_FUDBALA' },
      ...
      opcijeSaKimZivi:[
                { label: this.$t('administration.players.obaRoditelja'),  value: 'OBA_RODITELJA' },
                { label: this.$t('administration.players.majka'),  value: 'MAJKA' },
                { label: this.$t('administration.players.otac'),  value: 'OTAC' },
                { label: this.$t('administration.players.nijedno'),  value: 'SAMOSTALNO' },
                { label: this.$t('administration.players.samostalno'),  value: 'STARATELJ' }
              ],
  ...
  methods: {
    ...
    dropFile(evt){
      if(this.$refs.customFileInput == undefined)
        return
    ...
    otvoriPreviewDialog(item){
      ...
      this.editedItem.datumRodjenja = date.formatDate(this.editedItem.datumRodjenja, 'DD/MM/YYYY')
      if(this.editedItem.vaznostPasosa != '')
      this.editedItem.vaznostPasosa = date.formatDate(this.editedItem.vaznostPasosa, 'DD/MM/YYYY')
      this.readonly = true;
    ...
    debugger
      ...
      if(this.editedItem.vaznostPasosa != '' && this.editedItem.vaznostPasosa != undefined)
...
debugger
      this.$axios
        ...
        .catch(function(error) {
          ...
          if(error.response.data.exceptionMsg.includes("Already exists user with email"))
            self.$q.notify({
...
debugger
    ...
    addRow() {
      ...
      if (this.editedItem.pol == null || this.editedItem.pol == "")
        sveOK = false;
      if (this.editedItem.datumRodjenja == null || this.editedItem.datumRodjenja == "")
        sveOK = false;
      if (this.editedItem.drzavljanstvo == null || this.editedItem.drzavljanstvo == "")
        sveOK = false;
      if (this.editedItem.adresa == null || this.editedItem.adresa == "")
        sveOK = false;
      if (this.editedItem.kakoJeDosaoUKlub == null || this.editedItem.kakoJeDosaoUKlub == "")
        sveOK = false;
