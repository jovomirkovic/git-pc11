<template>
  <q-page class="q-pa-sm">
    <q-table
      :title="$t('technicalElements.assessmentOfTechnicalElement')"
      :data="data"
    ...
    >
      <template
        v-if="igrac != $t('technicalElements.selectPlayer') + ' ->'"
        v-slot:top-right="props"
      >
        <q-btn
          v-if="Object.keys(selektovaniIgrac).length != 0"
          @click="novaOcena()"
          :label="$t('technicalElements.newScore')"
        ...
        <!-- <q-btn
            ...
            >
              <q-tooltip
                ...
                v-close-popup
              >{{props.inFullscreen ? $t('technicalElements.exitFullscreen') : $t('technicalElements.enterFullscreen')}}</q-tooltip>
            </q-btn> -->
        ...
        >
          <q-tooltip :disable="$q.platform.is.mobile" v-close-popup>{{
            mode === "grid"
              ? $t("technicalElements.list")
              : $t("technicalElements.grid")
          }}</q-tooltip>
        </q-btn>
        ...
        <q-td :props="props" v-if="props.value == props.row.action">
          <div class="q-gutter-sm">
            <q-btn
              ...
              icon="delete"
            >
              <q-tooltip>{{ $t("technicalElements.delete") }}</q-tooltip>
            </q-btn>
            <q-btn
              ...
              icon="edit"
            >
              <q-tooltip>{{ $t("technicalElements.changeData") }}</q-tooltip>
            </q-btn>
          </div>
        </q-td>
              ...
              <q-item style="">
                <label class="custom-field one datumInput">
                  ...
                  <span id="Span-IP1" class="placeholder">{{
                    $t("technicalElements.date")
                  }}</span>
                </label>
              </q-item>
              <q-item>
                <q-item-section class="custom-field one">
                  <!-- TODO isto kao i u taktici ne ucitava se listaGrupa -->
                  <q-select
                    :readonly="readonly"
                    borderless
                    class="selektKlass"
                    ...
                    :rules="[
                      val =>
                        (val !== null && val !== '') ||
                        $t('technicalElements.pleaseSelectAGroup')
                    ]"
                  />
                  <span
                    ...
                    >{{ $t("technicalElements.pleaseSelectAGroup") }}</span
                  >
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section class="custom-field one">
                  <q-select
                    ...
                    option-label="label"
                    :options="listaStavki"
                    v-model="editedItem.tehnikaIdent"
                    emit-value
                    map-options
                    ref="select2"
                    ...
                    @blur="
                      spustiPlaceholder('Span-SL2', editedItem.tehnikaIdent)
                    "
                    :rules="[
                      val =>
                        (val !== null && val !== '') ||
                        $t('technicalElements.pleaseChooseYourTechnique')
                    ]"
                  />
                  <span
                    ...
                    id="Span-SL2"
                    class="placeholder placeholder1"
                    >{{ $t("technicalElements.technique") }}</span
                  >
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section class="custom-field one">
                  <q-select
                    ...
                    :rules="[
                      val =>
                        (val !== null && val !== '') ||
                        $t('technicalElements.pleaseChooseYourLevelOfAdoption')
                    ]"
                  />
                  <span
                    ...
                    id="Span-SL3"
                    class="placeholder placeholder1"
                    >{{ $t("technicalElements.levelOfAdoption") }}</span
                  >
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section class="custom-field one">
                  <q-select
                    ...
                    option-label="label"
                    :options="daNe"
                    v-model="editedItem.sekundarnaNogaSlicno"
                    emit-value
                    map-options
                    ref="select4"
                    ...
                    @blur="
                      spustiPlaceholder(
                        'Span-SL4',
                        editedItem.sekundarnaNogaSlicno
                      )
                    "
                    :rules="[
                      val =>
                        (val !== null && val !== '') ||
                        $t(
                          'technicalElements.pleaseChooseASimilarityOfTheSecondaryLeg'
                        )
                    ]"
                  />
                  <span
                    ...
                    id="Span-SL4"
                    class="placeholder placeholder1"
                    >{{ $t("technicalElements.secondaryLegSimilar") }}</span
                  >
                </q-item-section>
              </q-item>
            </q-list>
            ...
            <q-list>
              <q-item class="formular ponisti" style="">
                <q-input
                  ...
                  outlined
                  v-model="editedItem.vremeOcene"
                  :label="$t('technicalElements.date')"
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-select
                    ...
                    :label="$t('technicalElements.group')"
                    :options="listaGrupa"
                    v-model="editedItem.grupaIdent"
                    emit-value
                    map-options
              ...
              <q-item>
                <q-item-section>
                  <q-select
                    ...
                    borderless
                    style="background: #f5f8fb; color: #323b62; height: 45px; border-radius: 5px; padding-left: 14px !important;"
                    :label="$t('technicalElements.technique')"
                    :options="listaStavki"
                    v-model="editedItem.tehnikaIdent"
                    emit-value
                    map-options
              ...
              <q-item>
                <q-item-section>
                  <q-select
                    ...
                    style="background: #f5f8fb; color: #323b62; height: 45px; border-radius: 5px; padding-left: 14px !important;"
                    v-model="editedItem.nivoUsvajanja"
                    :label="$t('technicalElements.levelOfAdoption')"
                    :options="listaOd1Do5"
                    emit-value
                    map-options
                  />
              ...
              <q-item>
                <q-item-section>
                  <q-select
                    ...
                    borderless
                    style="background: #f5f8fb; color: #323b62; height: 45px; border-radius: 5px; padding-left: 14px !important;"
                    :label="$t('technicalElements.secondaryLegSimilar')"
                    :options="daNe"
                    v-model="editedItem.sekundarnaNogaSlicno"
                    emit-value
                    map-options
...
export default {
  ...
  data() {
    return {
      ...
      listaGrupa: [],
      daNe: [
        { label: this.$t("technicalElements.yes"), value: 1 },
        { label: this.$t("technicalElements.no"), value: 0 }
      ],
      ...
      editedItem: {
        ...
        selekcijaIdent: 0,
        bazaTehnikeSifrarnikStavkeIdent: null,
        trenerIdent: 0
      },
      defaultItem: {
        vremeOcene: "",
      ...
      columns: [
        {
          name: "vremeOcene",
          required: true,
          label: this.$t("technicalElements.date"),
          align: "left",
          field: "vremeOcene",
          sortable: true,
        ...
        },
        {
          name: "nazivGrupe",
          align: "left",
          label: this.$t("technicalElements.group"),
          field: "nazivGrupe",
          sortable: true
        },
        {
          name: "nazivTehnike",
          align: "left",
          label: this.$t("technicalElements.technique"),
          field: "nazivTehnike",
          sortable: true
        },
        {
          name: "nivoUsvajanja",
          align: "left",
          label: this.$t("technicalElements.levelOfAdoption"),
          field: "nivoUsvajanja",
          sortable: true
        },

        {
          name: "action",
          align: "left",
          label: this.$t("technicalElements.action"),
          field: "action",
          sortable: true
        }
      ],
  ...
  mounted() {
    if (
      ...
      this.getDataElements(); //uzmemo ocene elemenata
  ...
  methods: {
    ...
    getDataGrupe() {
      ...
      this.$axios
        ...
        .then(response => {
          debugger;
          self.listaGrupa = response.data.map(this.dajGrupe);
          self.loadingUtakmice = false;
          debugger;
        })
        .catch(e => {
    ...
    getDataStavke() {
      ...
      this.$axios
        ...
        .then(response => {
          self.listaStavki = response.data.map(this.dajStavke);
    ...
    //........................................
    getDataZaID() {
      let linkStr = this.$apiPutanja + "/ocena-tehnike/igrac/" + this.igracID1;
      self.loadingUtakmice = true;
      debugger;
      this.$axios
        .get(linkStr, {
    ...
    postData() {
      debugger;
      let linkStr = this.$apiPutanja + "/ocena-tehnike";
      var self = this;
      var vremeOcene1;
      try {
      ...
      var dataString = {
        ...
        sekundarnaNogaSlicno: this.editedItem.sekundarnaNogaSlicno,
        selekcijaIdent: this.timID1,
        bazaTehnikeSifrarnikStavkeIdent: this.editedItem.tehnikaIdent,
        trenerIdent: window.$userID
      };
      console.log(dataString);

      // {
      //   "vremeOcene": "2023-05-16T13:15:09.053Z"
      //   "igracIdent": 0,
      //   "nivoUsvajanja": 0,
      //   "sekundarnaNogaSlicno": 0,
      //   "selekcijaIdent": 0,
      //   "bazaTehnikeSifrarnikStavkeIdent": 0,
      //   "trenerIdent": 0,
      // }
      debugger;
      ...
      this.$axios
        ...
        .then(function(response) {
          ...
          self.getDataZaID();
          self.$q.notify({
            message: self.$t("technicalElements.newScoreSuccessfullyAdded"),
            color: "green"
          });
        })
    ...
    putData() {
      debugger;
      let linkStr =
        this.$apiPutanja + "/ocena-tehnike/" + this.editedItem.ident;
      var self = this;
      var vremeOcene1;
      try {
        vremeOcene1 = this.getDateTime(this.editedItem.vremeOcene);
      ...
      this.$axios
        ...
        .then(function(response) {
          ...
          self.getDataZaID();
          self.$q.notify({
            message: self.$t("technicalElements.scoreDataChangedSuccessfully"),
            color: "green"
          });
        })
        .catch(function(response) {
    ...
    //........................................
    deleteData(item) {
      let linkStr = this.$apiPutanja + "/ocena-tehnike/" + item.ident;
      var self = this;
      this.$axios
        .delete(linkStr, {
          headers: {
        ...
        .then(function(response) {
          ...
          self.getDataZaID();
          self.$q.notify({
            message: self.$t("technicalElements.scoreDataDeletedSuccessfuly"),
            color: "green"
          });
        })
        .catch(function(response) {
    ...
    addRow() {
      ...
      if (
        ...
        sveOK = false;
      if (
        this.editedItem.tehnikaIdent == null ||
        this.editedItem.tehnikaIdent == ""
      )
        sveOK = false;
      if (
      ...
      if (sveOK == false) {
        this.$q.notify({
          message: self.$t("technicalElements.dataNotSaved"),
          color: "red"
        });
        this.zacrveniPrazne();
      } else {
    ...
    deleteItem(item) {
      ...
      let obj = {
        title: self.$t("technicalElements.warning"),
        message: self.$t("technicalElements.areYouSureDelete"),
        customCloseBtnText: self.$t("technicalElements.no"),
        disableOverlayClick: true,
        useConfirmBtn: true,
        customConfirmBtnText: self.$t("technicalElements.yes"),
    ...
    exportTable() {
      ...
      if (status !== true) {
        this.$q.notify({
          message: self.$t("technicalElements.browserForbids"),
          color: "negative",
          icon: "warning"
        });
      }
