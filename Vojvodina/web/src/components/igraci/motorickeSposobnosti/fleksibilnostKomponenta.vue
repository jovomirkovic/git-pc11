  ...
  <q-page class="q-pa-sm">
    <!-- <div class="row"
          style="
            ...
            margin: 0 30%;"
            >
            <h5> {{$t('players.motorSkills.flexibility.selectedPlayer')}}: {{this.igrac}}</h5>
            <q-btn style="padding:22px;margin:10px;color:red" flat round icon="people" @click="izborIgraca()" >
              <q-tooltip>{{$t('players.motorSkills.flexibility.browsePlayers')}}</q-tooltip>
            </q-btn>
        </div> -->
    <q-table
      :title="$t('players.motorSkills.flexibility.flexibility')"
      :data="data"
    ...
    >
      <template
        v-if="igr != $t('players.motorSkills.flexibility.selectPlayer') + ' ->'"
        v-slot:top-right="props"
      >
        <q-btn
          v-if="Object.keys(selektovaniIgrac).length != 0"
          @click="otvordeDialog()"
          :label="$t('players.motorSkills.flexibility.newMesurement')"
        ...
        <!-- <q-btn
            ...
            >
              <q-tooltip
                ...
                v-close-popup
              >{{props.inFullscreen ? $t('players.motorSkills.flexibility.exitFullscreen') : $t('players.motorSkills.flexibility.enterFullscreen')}}</q-tooltip>
            </q-btn> -->
        ...
        >
          <q-tooltip :disable="$q.platform.is.mobile" v-close-popup>{{
            mode === "grid"
              ? $t("players.motorSkills.flexibility.list")
              : $t("players.motorSkills.flexibility.grid")
          }}</q-tooltip>
        </q-btn>

        <q-btn
          class="dugmeCVS"
          :label="$t('players.motorSkills.flexibility.exportCSV')"
          no-caps
          @click="exportTable"
        />
      </template>
      ...
      <template v-slot:body-cell="props">
        <q-td :props="props" v-if="props.value == props.row.action">
          <div class="q-gutter-sm">
            ...
            >
              <q-tooltip>{{
                $t("players.motorSkills.flexibility.delete")
              }}</q-tooltip>
            </q-btn>
            <q-btn
            ...
            >
              <q-tooltip>{{
                $t("players.motorSkills.flexibility.changeData")
              }}</q-tooltip>
            </q-btn>
          </div>
        </q-td>
      ...
      >
        <q-card-section>
          ...
          <div class="text-h6" style="text-align: center;">
            {{ $t("players.motorSkills.flexibility.mesurement") }}
          </div>
        </q-card-section>
            ...
            <q-list>
              <q-item class="formular ponisti" style="">
                <q-input
                  ...
                  :label="$t('players.motorSkills.flexibility.date')"
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      ...
                      :label="
                        $t('players.motorSkills.flexibility.whoDidTheTesting')
                      "
                    />
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.sedeciPretklon"
                      :label="$t('players.motorSkills.flexibility.nextBow')"
                    />
                    <span class="placeholder">{{
                      $t("players.motorSkills.flexibility.nextBow")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.adukcija"
                      :label="
                        $t(
                          'players.motorSkills.flexibility.abductionInTheSupinePosition'
                        )
                      "
                    />
                    <span class="placeholder">{{
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.tomasKukLevo"
                      :label="
                        $t('players.motorSkills.flexibility.thomasTestHipLeft')
                      "
                    />
                    <span class="placeholder">{{
                      $t("players.motorSkills.flexibility.thomasTestHipLeft")
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.tomasKukDesno"
                      :label="
                        $t('players.motorSkills.flexibility.thomasTestHipRight')
                      "
                    />
                    <span class="placeholder">{{
                      $t("players.motorSkills.flexibility.thomasTestHipRight")
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.tomasKolenoLevo"
                      :label="
                        $t('players.motorSkills.flexibility.thomasTestKneeLeft')
                      "
                    />
                    <span class="placeholder">{{
                      $t("players.motorSkills.flexibility.thomasTestKneeLeft")
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.tomasKolenoDesno"
                      :label="
                        $t(
                          'players.motorSkills.flexibility.thomasTestKneeRight'
                        )
                      "
                    />
                    <span class="placeholder">{{
                      $t("players.motorSkills.flexibility.thomasTestKneeRight")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.dorzofleksijaLevo"
                      :label="
                        $t('players.motorSkills.flexibility.dorsoflexiaLeft')
                      "
                    />
                    <span class="placeholder">{{
                      $t("players.motorSkills.flexibility.dorsoflexiaLeft")
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      readonly
                      placeholder=" "
                      v-model="editedItem.dorzofleksijaDesno"
                      :label="
                        $t('players.motorSkills.flexibility.dorsoflexiaRight')
                      "
                    />
                    <span class="placeholder">{{
                      $t("players.motorSkills.flexibility.dorsoflexiaRight")
    ...
    <q-dialog persistent v-model="new_customer">
      ...
      >
          ...
          <q-form class="q-gutter-md">
            <q-list>
              <q-item class="formular ponisti" style="width: 40%;">
                <label class="custom-field one datumInput">
                  ...
                  <span id="Span-IP0" class="placeholder">{{
                    $t("players.motorSkills.flexibility.date")
                  }}</span>
                </label>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <q-input
                      ...
                      @blur="
                        spustiPlaceholder('Span-IP2', editedItem.sedeciPretklon)
                      "
                    />
                    <span id="Span-IP2" class="placeholder"
                      >{{ $t("players.motorSkills.flexibility.nextBow") }} [cm]
                    </span>
                  </label>
                </q-item-section>
              </q-item>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <q-input
                      ...
                      @blur="spustiPlaceholder('Span-IP3', editedItem.adukcija)"
                    />
              ...
              <q-item>
                <q-item-section>
                  <label class="custom-field one" style="height: 75px;">
                    <!-- <input placeholder=" " v-model="editedItem.tomasKukLevo" :label="$t('players.motorSkills.flexibility.thomasTestHipLeft')"/> -->
                    <p
                      style="
                            text-align: center;
                            color: #000000;
                    ...
                    <div
                      ...
                      :key="item + ' ' + index"
                      @click="editedItem.tomasKukLevo = item.value"
                      style="
                      ...
                      :style="{
                        border: [
                          editedItem.tomasKukLevo == item.value
                            ? '2px solid #3b5d99'
                            : '2px solid white'
                        ]
                      }"
              ...
              <q-item>
                <q-item-section>
                  <label class="custom-field one" style="height: 75px;">
                    <!-- <input placeholder=" " v-model="editedItem.tomasKukLevo" :label="$t('players.motorSk  ills.flexibility.thomasTestHipLeft')"/> -->
                    <p
                      style="
                            text-align: center;
                            color: #000000;
                    ...
                    <div
                      ...
                      v-for="(item, index) in thomasTest4Options"
                      :key="item + ' ' + index"
                      @click="editedItem.tomasKukDesno = item.value"
                      style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                      ...
                      :style="{
                        border: [
                          editedItem.tomasKukDesno == item.value
                            ? '2px solid #3b5d99'
                            : '2px solid white'
                        ]
                      }"
                ...
                <q-item-section>
                  <label class="custom-field one" style="height: 75px;">
                    ...
                    <div
                      ...
                      v-for="(item, index) in thomasTest4Options"
                      :key="item + ' ' + index"
                      @click="editedItem.tomasKolenoLevo = item.value"
                      style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                      ...
                      :style="{
                        border: [
                          editedItem.tomasKolenoLevo == item.value
                            ? '2px solid #3b5d99'
                            : '2px solid white'
                        ]
                      }"
                ...
                <q-item-section>
                  ...
                  >
                    ...
                    <div
                      ...
                      v-for="(item, index) in thomasTest4Options"
                      :key="item + ' ' + index"
                      @click="editedItem.tomasKolenoDesno = item.value"
                      style="
                            display: inline-block;
                            width: 21%;
                            margin: 2%;
                      ...
                      :style="{
                        border: [
                          editedItem.tomasKolenoDesno == item.value
                            ? '2px solid #3b5d99'
                            : '2px solid white'
                        ]
                      }"
        ...
        >
          <q-btn
            :label="$t('players.motorSkills.flexibility.cancel')"
            @click="close"
            type="submit"
          ...
          ></q-btn>
          <q-btn
            :label="$t('players.motorSkills.flexibility.save')"
            @click="addRow"
            type="submit"
...
export default {
      ...
      columns: [
        {
          name: "datumVreme",
          required: true,
          label: this.$t("players.motorSkills.flexibility.date"),
          align: "left",
          field: "datumVreme",
          sortable: true,
        ...
        },
        {
          name: "adukcija",
          align: "left",
          label: this.$t("players.motorSkills.flexibility.adduction"),
          field: "adukcija",
          sortable: true
        },
        {
          name: "dorzofleksijaLevo",
          align: "left",
          label: this.$t("players.motorSkills.flexibility.dorsoflexiaLeft"),
          field: "dorzofleksijaLevo",
          sortable: true
        },
        {
          name: "action",
          align: "left",
          label: this.$t("players.motorSkills.flexibility.action"),
          field: "action",
          sortable: true
        }
      ],
  ...
  methods: {
    ...
    //........................................
    getDataZaID() {
      let linkStr = this.$apiPutanja + "/fleksibilnost/igrac/" + this.igrID;
    ...
    postData() {
      debugger;
      let linkStr = this.$apiPutanja + "/fleksibilnost";
      var self = this;
      var datumVreme1;
      try {
      ...
      var dataString = {
        adukcija: this.editedItem.adukcija,
        ...
        identUser: parseFloat(this.igrID),
        sedeciPretklon: this.editedItem.sedeciPretklon,
        dorzofleksijaDesno: parseFloat(this.editedItem.dorzofleksijaDesno),
        dorzofleksijaLevo: parseFloat(this.editedItem.dorzofleksijaLevo),
        tomasKolenoDesno: parseFloat(this.editedItem.tomasKolenoDesno),
        tomasKolenoLevo: parseFloat(this.editedItem.tomasKolenoLevo),
        tomasKukDesno: parseFloat(this.editedItem.tomasKukDesno),
        tomasKukLevo: parseFloat(this.editedItem.tomasKukLevo)
      };
      ...
      this.$axios
        ...
        .then(function(response) {
          ...
          self.$q.notify({
            message: self.$t(
              "players.motorSkills.flexibility.newMeasurementSuccessfullyAdded"
            ),
            color: "green"
          });
        })
    ...
    putData() {
      debugger;
      let linkStr =
        this.$apiPutanja + "/fleksibilnost/" + this.editedItem.ident;
      var self = this;
      var datumVreme1;
      try {
        datumVreme1 = this.getDateTime(this.editedItem.datumVreme);
    ...
    //........................................
    deleteData(item) {
      let linkStr = this.$apiPutanja + "/fleksibilnost/" + item.ident;
      var self = this;
      this.$axios
        .delete(linkStr, {
          headers: {
        ...
        .then(function(response) {
          ...
          self.$q.notify({
            message: self.$t(
              "players.motorSkills.flexibility.measurementdataDeletedSuccessfully"
            ),
            color: "green"
          });
        })
    ...
    deleteItem(item) {
      ...
      let obj = {
        title: self.$t("players.motorSkills.flexibility.warning"),
        message: self.$t("players.motorSkills.flexibility.areYouSureDelete"),
        customCloseBtnText: self.$t("players.motorSkills.flexibility.no"),
        disableOverlayClick: true,
        useConfirmBtn: true,
        customConfirmBtnText: self.$t("players.motorSkills.flexibility.yes"),
    ...
    exportTable() {
      ...
      const status = exportFile("fleksibilnost.csv", content, "text/csv");
      let self = this;
      if (status !== true) {
        this.$q.notify({
          message: self.$t(
