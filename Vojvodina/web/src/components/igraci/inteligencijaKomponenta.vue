  ...
  <q-page class="q-pa-sm">
    <!-- <div class="row"
          style="
            ...
            margin: 0 30%;"
            >
            <h5> {{$t('players.intelligence.selectedPlayer')}}: {{this.igrac}}</h5>
            <q-btn style="padding:22px;margin:10px;color:red" flat round icon="people" @click="izborIgraca()" >
              <q-tooltip>{{$t('players.intelligence.browsePlayers')}}</q-tooltip>
            </q-btn>
        </div> -->
    <q-table
      :title="$t('players.intelligence.intelligence')"
      :data="data"
    ...
    >
      <template
        v-if="igr != $t('players.intelligence.selectPlayer') + ' ->'"
        v-slot:top-right="props"
      >
        <q-btn
          v-if="Object.keys(selektovaniIgrac).length != 0"
          @click="otvordeDialog()"
          :label="$t('players.intelligence.newMesurement')"
        ...
        <!-- <q-btn
            ...
            >
              <q-tooltip
                ...
                v-close-popup
              >{{props.inFullscreen ? $t('players.intelligence.exitFullscreen') : $t('players.intelligence.enterFullscreen')}}</q-tooltip>
            </q-btn> -->
        ...
        >
          <q-tooltip :disable="$q.platform.is.mobile" v-close-popup>{{
            mode === "grid"
              ? $t("players.intelligence.list")
              : $t("players.intelligence.grid")
          }}</q-tooltip>
        </q-btn>

        <q-btn
          class="dugmeCVS"
          :label="$t('players.intelligence.exportCSV')"
          no-caps
          @click="exportTable"
        />
      </template>
        ...
        <q-td :props="props" v-if="props.value == props.row.action">
          <div class="q-gutter-sm">
            <q-btn
              ...
              icon="delete"
            >
              <q-tooltip>{{ $t("players.intelligence.delete") }}</q-tooltip>
            </q-btn>
            <q-btn
              ...
              icon="edit"
            >
              <q-tooltip>{{ $t("players.intelligence.changeData") }}</q-tooltip>
            </q-btn>
          </div>
        </q-td>
      ...
      >
        <q-card-section>
          ...
          <div class="text-h6" style="text-align: center;">
            {{ $t("players.intelligence.mesurement") }}
          </div>
        </q-card-section>
          ...
          <q-form class="q-gutter-md">
            <q-list>
              ...
              <q-item class="formular ponisti" style="width: 64%">
                <q-item-section>
                  <!-- <q-input dense outlined v-model="editedItem.korisnikImePrezime" :label="$t('players.intelligence.whoDidTheTesting')"></q-input> -->
                  <label class="custom-field one">
                    ...
                    <span id="Span-IP1" class="placeholder">{{
                      $t("players.intelligence.whoDidTheTesting")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
              ...
              <q-item>
                <q-item-section>
                  <!-- <q-input type="number" dense outlined v-model="editedItem.f1" :label="$t('players.intelligence.f1036')"
                      :rules="[
                        val => val >= 0 && val < 37 || $t('players.intelligence.insertValueBetwen0and36')
                      ]"
                      ></q-input> -->
                  <label class="custom-field one">
                    <q-input
                      ...
                      type="text"
                      placeholder=" "
                      v-model="editedItem.f1"
                      mask="##"
                      :rules="[
                        val =>
                          (val >= 0 && val < 37) ||
                          $t('players.intelligence.insertValueBetwen0and36')
                      ]"
                      @focus="popniPlaceholder('Span-IP2')"
                      @input="popniPlaceholder('Span-IP2')"
                      @blur="spustiPlaceholder('Span-IP2', editedItem.f1)"
                    />
                    <span id="Span-IP2" class="placeholder">{{
                      $t("players.intelligence.f1036")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <!-- <q-input  type="number" dense outlined v-model="editedItem.s1" :label="$t('players.intelligence.s1030')"
                      :rules="[
                        val => val >= 0 && val < 31 || $t('players.intelligence.insertValueBetwen0and30')
                      ]"
                      ></q-input> -->
                  <label class="custom-field one">
                    <q-input
                      ...
                      :rules="[
                        val =>
                          (val >= 0 && val < 31) ||
                          $t('players.intelligence.insertValueBetwen0and30')
                      ]"
                      @focus="popniPlaceholder('Span-IP3')"
                      @input="popniPlaceholder('Span-IP3')"
                      @blur="spustiPlaceholder('Span-IP3', editedItem.s1)"
                    />
                    <span id="Span-IP3" class="placeholder">{{
                      $t("players.intelligence.s1030")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <!-- <q-input dense outlined v-model="editedItem.elektricnaMreza" :label="$t('players.intelligence.electricalNetwork')"></q-input> -->
                  <label class="custom-field one">
                    <q-input
                      :readonly="readonly"
                      borderless
                      ...
                      placeholder=" "
                      mask="#### #### #### ####"
                      v-model="editedItem.elektricnaMreza"
                      @focus="popniPlaceholder('Span-IP4')"
                      @input="popniPlaceholder('Span-IP4')"
                      @blur="
                        spustiPlaceholder(
                          'Span-IP4',
                          editedItem.elektricnaMreza
                        )
                      "
                    />
                    <span id="Span-IP4" class="placeholder">{{
                      $t("players.intelligence.electricalNetwork")
                    }}</span>
                  </label>
                </q-item-section>
              </q-item>
            ...
            <q-list>
              <q-item class="formular ponisti" style="">
                <q-input
                  ...
                  outlined
                  v-model="editedItem.datumVreme"
                  :label="$t('players.intelligence.date')"
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      ...
                      placeholder=" "
                      v-model="editedItem.korisnikImePrezime"
                      :label="$t('players.intelligence.whoDidTheTesting')"
                    />
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      ...
                      placeholder=" "
                      v-model="editedItem.f1"
                      :label="$t('players.intelligence.f1036')"
                    />
                    <span class="placeholder">{{
                      $t("players.intelligence.f1036")
                    }}</span>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      ...
                      placeholder=" "
                      v-model="editedItem.s1"
                      :label="$t('players.intelligence.s1030')"
                    />
                    <span class="placeholder">{{
                      $t("players.intelligence.s1030")
                    }}</span>
                ...
                <q-item-section>
                  <label class="custom-field one">
                    <input
                      ...
                      placeholder=" "
                      v-model="editedItem.elektricnaMreza"
                      :label="$t('players.intelligence.electricalNetwork')"
                    />
                    <span class="placeholder">{{
                      $t("players.intelligence.electricalNetwork")
                    }}</span>
...
export default {
      ...
      columns: [
        {
          name: "datumVreme",
          required: true,
          label: this.$t("players.intelligence.date"),
          align: "left",
          field: "datumVreme",
          sortable: true,
        ...
        },
        {
          name: "f1",
          align: "left",
          label: this.$t("players.intelligence.f1"),
          field: "f1",
          sortable: true
        },
        {
          name: "s1",
          align: "left",
          label: this.$t("players.intelligence.s1"),
          field: "s1",
          sortable: true
        },
        {
          name: "action",
          align: "left",
          label: this.$t("players.intelligence.action"),
          field: "action",
          sortable: true
        }
      ],
  ...
  methods: {
    ...
    //........................................
    getDataZaID() {
      let linkStr = this.$apiPutanja + "/inteligencija/igrac/" + this.igrID;
    ...
    postData() {
      debugger;
      let linkStr = this.$apiPutanja + "/inteligencija";
      var self = this;
      var datumVreme1;
      try {
      ...
      var dataString = {
        ...
        userIdent: this.igrID,
        f1: this.editedItem.f1,
        s1: this.editedItem.s1,
        elektricnaMreza: this.editedItem.elektricnaMreza
      };
      ...
      this.$axios
        ...
        .then(function(response) {
          ...
          self.$q.notify({
            message: self.$t(
              "players.intelligence.newMeasurementSuccessfullyAdded"
            ),
            color: "green"
          });
        })
    ...
    putData() {
      debugger;
      let linkStr =
        this.$apiPutanja + "/inteligencija/" + this.editedItem.ident;
      var self = this;
      var datumVreme1;
      try {
        datumVreme1 = this.getDateTime(this.editedItem.datumVreme);
      ...
      this.$axios
        ...
        .then(function(response) {
          ...
          self.$q.notify({
            message: self.$t(
              "players.intelligence.measurementDataChangedSuccessfully"
            ),
            color: "green"
          });
        })
    ...
    //........................................
    deleteData(item) {
      let linkStr = this.$apiPutanja + "/inteligencija/" + item.ident;
      var self = this;
      this.$axios
        .delete(linkStr, {
          headers: {
        ...
        .then(function(response) {
          ...
          self.$q.notify({
            message: self.$t(
              "players.intelligence.measurementDataDeletedSuccessfully"
            ),
            color: "green"
          });
        })
    ...
    deleteItem(item) {
      ...
      let obj = {
        title: self.$t("players.intelligence.warning"),
        message: self.$t("players.intelligence.areYouSureDelete"),
        customCloseBtnText: self.$t("players.intelligence.no"),
        disableOverlayClick: true,
        useConfirmBtn: true,
        customConfirmBtnText: self.$t("players.intelligence.yes"),
    ...
    exportTable() {
      ...
      const status = exportFile("inteligencija.csv", content, "text/csv");
      let self = this;
      if (status !== true) {
        this.$q.notify({
          message: self.$t("players.intelligence.browserForbids"),
          color: "negative",
          icon: "warning"
        });
      }
